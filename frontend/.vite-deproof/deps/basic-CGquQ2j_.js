...
import { a as nothing, l as css, o as svg, r as html, t as LitElement } from "./lit-CFHzPFdE.js";
import { a as state, i as ifDefined, n as AsyncDirective, o as property, r as directive, t as classMap } from "./wui-text-C5iildNr.js";
import { A as StorageUtil, C as EventsController, E as AssetController, F as ConstantsUtil, O as OptionsController, S as ApiController, T as AssetUtil, _ as SnackController, a as elementStyles, b as ThemeController, g as ConnectionController, i as colorStyles, j as ConstantsUtil$1, k as CoreHelperUtil, n as customElement, p as ChainController, r as UiHelperUtil, s as resetStyles, u as ModalController, x as RouterController, y as ConnectorController } from "./ConstantsUtil-BtXDJJY6.js";
import { n as WalletUtil, t as ConnectorUtil } from "./ConnectorUtil-Bx8ICvpP.js";
...
var WuiWalletImage = class WuiWalletImage extends LitElement {
	constructor() {
		super(...arguments);
		this.size = "md";
		this.name = "";
...
var TOTAL_IMAGES = 4;
var WuiAllWalletsImage = class WuiAllWalletsImage extends LitElement {
	constructor() {
		super(...arguments);
		this.walletImages = [];
	}
...
var WuiListWallet = class WuiListWallet extends LitElement {
	constructor() {
		super(...arguments);
		this.walletImages = [];
		this.imageSrc = "";
...
var W3mAllWalletsWidget = class W3mAllWalletsWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectAnnouncedWidget = class W3mConnectAnnouncedWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectCustomWidget = class W3mConnectCustomWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
	...
	render() {
      ...
      ${this.filterOutDuplicateWallets(customWallets).map((wallet) => html`
          <wui-list-wallet
...
var W3mConnectExternalWidget = class W3mConnectExternalWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectFeaturedWidget = class W3mConnectFeaturedWidget extends LitElement {
	constructor() {
		super(...arguments);
		this.tabIdx = void 0;
		this.wallets = [];
...
var W3mConnectInjectedWidget = class W3mConnectInjectedWidget extends LitElement {
	constructor() {
		super(...arguments);
		this.tabIdx = void 0;
		this.connectors = [];
...
var W3mConnectMultiChainWidget = class W3mConnectMultiChainWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectRecentWidget = class W3mConnectRecentWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectRecommendedWidget = class W3mConnectRecommendedWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var W3mConnectWalletConnectWidget = class W3mConnectWalletConnectWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
	...
	render() {
		...
		return html`
      <wui-list-wallet
        imageSrc=${ifDefined(connector.imageUrl || this.connectorImages[connector?.imageId ?? ""])}
        name=${connector.name ?? "Unknown"}
        @click=${() => this.onConnector(connector)}
        tagLabel="qr code"
        tagVariant="main"
...
var W3mConnectorList = class W3mConnectorList extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.tabIdx = void 0;
...
var WuiTabs = class WuiTabs extends LitElement {
	constructor() {
		super(...arguments);
		this.tabs = [];
...
var W3mConnectingHeader = class W3mConnectingHeader extends LitElement {
	constructor() {
		super(...arguments);
		this.platformTabs = [];
		this.unsubscribe = [];
...
var WuiButton = class WuiButton extends LitElement {
	constructor() {
		super(...arguments);
		this.size = "lg";
		this.disabled = false;
	...
	loadingTemplate() {
		if (this.loading) {
			...
			return html`<wui-loading-spinner color=${this.disabled ? SPINNER_COLOR_BY_VARIANT["disabled"] : SPINNER_COLOR_BY_VARIANT[this.variant]} size=${size}></wui-loading-spinner>`;
		}
		return html``;
	}
};
...
var WuiLink = class WuiLink extends LitElement {
	constructor() {
		super(...arguments);
		this.tabIdx = void 0;
		this.disabled = false;
...
var WuiLoadingThumbnail = class WuiLoadingThumbnail extends LitElement {
	constructor() {
		super(...arguments);
		this.radius = 36;
	}
...
var WuiChipButton = class WuiChipButton extends LitElement {
	constructor() {
		super(...arguments);
		this.variant = "accent";
		this.imageSrc = "";
...
var WuiCtaButton = class WuiCtaButton extends LitElement {
	constructor() {
		super(...arguments);
		this.disabled = false;
		this.label = "";
...
var W3mMobileDownloadLinks = class W3mMobileDownloadLinks extends LitElement {
	constructor() {
		super(...arguments);
		this.wallet = void 0;
	}
...
var W3mConnectingWidget = class extends LitElement {
	...
	loaderTemplate() {
		...
		return html`<wui-loading-thumbnail radius=${(borderRadiusMaster ? parseInt(borderRadiusMaster.replace("px", ""), 10) : 4) * 9}></wui-loading-thumbnail>`;
	}
	onCopyUri() {
		try {
			if (this.uri) {
...
var W3mConnectingWcBrowser = class W3mConnectingWcBrowser extends W3mConnectingWidget {
	constructor() {
		super();
...
var W3mConnectingWcDesktop = class W3mConnectingWcDesktop extends W3mConnectingWidget {
	constructor() {
		super();
...
var W3mConnectingWcMobile = class W3mConnectingWcMobile extends W3mConnectingWidget {
	constructor() {
		super();
...
var QrCodeUtil = { generate({ uri, size, logoSize, dotColor = "#141414" }) {
...
var WuiQrCode = class WuiQrCode extends LitElement {
	constructor() {
		super(...arguments);
		this.uri = "";
		this.size = 0;
...
var WuiShimmer = class WuiShimmer extends LitElement {
	constructor() {
		super(...arguments);
		this.width = "";
		this.height = "";
...
var WuiUxByReown = class WuiUxByReown extends LitElement {
	render() {
		return html`
      <a
...
var W3mConnectingWcQrcode = class W3mConnectingWcQrcode extends W3mConnectingWidget {
	constructor() {
		super();
		this.forceUpdate = () => {
			this.requestUpdate();
...
var W3mConnectingWcUnsupported = class W3mConnectingWcUnsupported extends LitElement {
	constructor() {
		super();
		this.wallet = RouterController.state.data?.wallet;
...
var W3mConnectingWcWeb = class W3mConnectingWcWeb extends W3mConnectingWidget {
	constructor() {
		super();
		this.isLoading = true;
...
var W3mConnectingWcView = class W3mConnectingWcView extends LitElement {
	constructor() {
		super();
		this.wallet = RouterController.state.data?.wallet;
		this.unsubscribe = [];
...
var W3mConnectingWcBasicView = class W3mConnectingWcBasicView extends LitElement {
	constructor() {
		super(...arguments);
	...
	render() {
      ...
      >
        ${featured.length || recommended.length || customWallets?.length || recent.length ? html`<w3m-connector-list></w3m-connector-list>` : null}
...
var WuiSwitch = class WuiSwitch extends LitElement {
	constructor() {
		super(...arguments);
...
var WuiCertifiedSwitch = class WuiCertifiedSwitch extends LitElement {
	constructor() {
		super(...arguments);
		this.checked = void 0;
	}
...
var WuiInputElement = class WuiInputElement extends LitElement {
	constructor() {
		super(...arguments);
		this.icon = "copy";
	}
...
var WuiInputText = class WuiInputText extends LitElement {
	constructor() {
		super(...arguments);
		this.inputElementRef = createRef();
		this.size = "md";
...
var WuiSearchBar = class WuiSearchBar extends LitElement {
	constructor() {
		super(...arguments);
...
var WuiCardSelectLoader = class WuiCardSelectLoader extends LitElement {
	constructor() {
		super(...arguments);
		this.type = "wallet";
	}
...
var WuiGrid = class WuiGrid extends LitElement {
	render() {
		this.style.cssText = `
...
var W3mAllWalletsListItem = class W3mAllWalletsListItem extends LitElement {
	constructor() {
		super();
...
var W3mAllWalletsList = class W3mAllWalletsList extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
...
var W3mAllWalletsSearch = class W3mAllWalletsSearch extends LitElement {
	constructor() {
		super(...arguments);
		this.prevQuery = "";
...
var W3mAllWalletsView = class W3mAllWalletsView extends LitElement {
	constructor() {
		super(...arguments);
		this.search = "";
...
var WuiListItem = class WuiListItem extends LitElement {
	constructor() {
		super(...arguments);
		this.tabIdx = void 0;
		this.variant = "icon";
...
var W3mDownloadsView = class W3mDownloadsView extends LitElement {
	constructor() {
		super(...arguments);
		this.wallet = RouterController.state.data?.wallet;
	}
...
//# sourceMappingURL=basic-CGquQ2j_.js.map