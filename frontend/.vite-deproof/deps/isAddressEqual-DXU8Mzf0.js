import { C as isAddress, D as AbiConstructorParamsNotFoundError, E as AbiConstructorNotFoundError, K as formatAbiItem, L as AbiFunctionNotFoundError, N as AbiErrorSignatureNotFoundError, O as AbiDecodingDataSizeTooSmallError, R as AbiFunctionOutputsNotFoundError, T as InvalidAddressError, U as InvalidAbiDecodingTypeError, _ as concatHex, c as execTyped, d as encodeAbiParameters, f as getArrayComponents, k as AbiDecodingZeroDataError, l as integerRegex, n as getAbiItem, r as toFunctionSelector, s as bytesRegex, t as encodeFunctionData, u as isTupleRegex, v as slice$2, x as checksumAddress, y as sliceBytes } from "./encodeFunctionData-YLQ8NBAq.js";
import { S as InvalidBytesLengthError, T as size$2, _ as trim$2, c as numberToHex, d as assertSize$2, h as hexToNumber$1, p as hexToBigInt, r as hexToBytes$1, s as bytesToHex$1, t as stringify$1, w as BaseError$2, y as InvalidBytesBooleanError$1 } from "./stringify-Bm23iD_D.js";
import { X as etherUnits, Y as formatGwei, a as FeeCapTooLowError, c as IntrinsicGasTooLowError, d as NonceTooLowError, f as TipAboveFeeCapError, i as FeeCapTooHighError, l as NonceMaxValueError, m as UnknownNodeError, o as InsufficientFundsError, p as TransactionTypeNotSupportedError, q as getContractAddress, r as ExecutionRevertedError, s as IntrinsicGasTooHighError, t as createBatchScheduler, u as NonceTooHighError } from "./createBatchScheduler-D2ue-dEZ.js";
...
function bytesToBigInt(bytes, opts = {}) {
	...
	return hexToBigInt(bytesToHex$1(bytes, opts), opts);
}
/**
...
function bytesToNumber(bytes, opts = {}) {
	if (typeof opts.size !== "undefined") assertSize$2(bytes, { size: opts.size });
	return hexToNumber$1(bytesToHex$1(bytes, opts), opts);
}
/**
...
function decodeAddress(cursor) {
	return [checksumAddress(bytesToHex$1(sliceBytes(cursor.readBytes(32), -20))), 32];
}
...
function decodeBytes(cursor, param, { staticPosition }) {
	...
	return [bytesToHex$1(cursor.readBytes(Number.parseInt(size, 10), 32)), 32];
}
...
var InvalidChainIdError = class extends BaseError$2 {
	constructor({ chainId }) {
...
var InvalidLegacyVError = class extends BaseError$2 {
	constructor({ v }) {
...
var InvalidStorageKeySizeError = class extends BaseError$2 {
...
//#endregion
//#region node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js
/**
...
function formatTransactionRequest(request, _) {
	...
	if (typeof request.blobs !== "undefined") if (typeof request.blobs[0] !== "string") rpcRequest.blobs = request.blobs.map((x) => bytesToHex$1(x));
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup, offchainLookupSignature } = await import("./ccip-DgFZtzNV.js");
...
//#endregion
export { aInRange as $, PositionOutOfBoundsError as $t, size as A, TransactionReceiptRevertedError as At, fromHex as B, InvalidChainIdError as Bt, fromBoolean as C, RawContractError as Ct, padLeft as D, TransactionExecutionError as Dt, fromString as E, InvalidStorageKeySizeError as Et, toString as F, solidityError as Ft, toBigInt$1 as G, parseSignature as Gt, isEqual as H, parseAbi as Ht, trimLeft as I, parseAccount as It, toString$1 as J, InvalidAbiItemError as Jt, toBoolean as K, splitParameters as Kt, validate as L, getChainContractAddress as Lt, toBigInt as M, prettyPrint as Mt, toBytes as N, formatEther as Nt, padRight as O, TransactionNotFoundError as Ot, toNumber as P, decodeErrorResult as Pt, BaseError as Q, createCursor as Qt, concat$1 as R, ChainMismatchError as Rt, from as S, ContractFunctionZeroDataError as St, fromNumber as T, InvalidSerializableTransactionError as Tt, size$1 as U, parseStructs as Ut, fromString$1 as V, decodeFunctionResult as Vt, slice$1 as W, parseAbiParameter as Wt, validate$1 as X, modifiers as Xt, trimLeft$1 as Y, isStructSignature as Yt, stringify as Z, decodeAbiParameters as Zt, toRpc as _, utf8ToBytes as _t, maxUint256 as a, multicall3Abi as an, bytesToNumberBE as at, assert as b, ContractFunctionExecutionError as bt, formatTransactionRequest as c, universalResolverReverseAbi as cn, createHmacDrbg as ct, getCallError as d, inRange as dt, addressResolverAbi as en, abool as et, getNodeError as f, isBytes as ft, multicall3Bytecode as g, numberToHexUnpadded as gt, erc6492SignatureValidatorByteCode as h, numberToBytesLE as ht, maxUint16 as i, erc6492SignatureValidatorAbi as in, bytesToHex as it, slice as j, WaitForTransactionReceiptTimeoutError as jt, random as k, TransactionReceiptNotFoundError as kt, defineFormatter as l, ensureBytes as lt, deploylessCallViaBytecodeBytecode as m, numberToBytesBE as mt, call as n, erc1271Abi as nn, bitLen as nt, serializeStateOverride as o, textResolverAbi as on, bytesToNumberLE as ot, encodeDeployData as p, memoized as pt, toNumber$1 as q, InvalidAbiParametersError as qt, assertRequest as r, erc20Abi as rn, bitMask as rt, defineTransactionRequest as s, universalResolverResolveAbi as sn, concatBytes as st, isAddressEqual as t, batchGatewayAbi as tn, abytes as tt, extract as u, hexToBytes as ut, IntegerOutOfRangeError as v, validateObject as vt, fromBytes as w, InvalidLegacyVError as wt, concat as x, ContractFunctionRevertedError as xt, InvalidLengthError as y, CallExecutionError as yt, from$1 as z, ChainNotFoundError as zt };

//# sourceMappingURL=isAddressEqual-DXU8Mzf0.js.map