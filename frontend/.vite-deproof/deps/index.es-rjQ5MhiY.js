...
import { A as safeJsonParse, C as sn$2, D as k$3, E as import_browser, F as require_cjs, M as i$1, N as r, O as y$3, P as IEvents, S as Qo$1, T as E$4, _ as require_cjs$2, a as isJsonRpcRequest, b as Po$2, c as formatJsonRpcError, d as getBigIntRpcId, f as payloadId, g as concat, h as fromString, i as isJsonRpcError, j as safeJsonStringify, k as h$2, l as formatJsonRpcRequest, m as toString, n as f$3, o as isJsonRpcResponse, p as C$4, r as o, s as isJsonRpcResult, t as f$4, u as formatJsonRpcResult, v as require_cjs$1, w as A$3, x as Qe$3, y as detect } from "./index.es-CAMq3-i7.js";
import { a as isLE, c as toBytes$1, f as abytes, g as aoutput, h as anumber, l as u32, n as byteSwap32, p as aexists, t as Hash, u as wrapConstructor } from "./utils-uEMnjZZK.js";
...
async function recoverPublicKey({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-D83Kia43.js");
	return `0x${(() => {
...
//#endregion
//#region node_modules/@walletconnect/utils/node_modules/base-x/src/esm/index.js
...
function Vn$1() {
	var t;
	const e = xt$2();
	return e === Y$3.browser ? [e, ((t = (0, import_cjs$1.getLocation)()) == null ? void 0 : t.host) || "unknown"].join(":") : e;
}
function Mn$1(t, e, n) {
	const r = kn$1(), o = Vn$1();
	return [
...
async function Si$1({ id: t, topic: e, wcDeepLink: n }) {
	...
	try {
		...
		if (c === Y$3.browser) {
			...
			Fn$1(s);
		} else c === Y$3.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
	} catch (o) {
		console.error(o);
	}
}
...
var Qi = Object.defineProperty, ts$1 = Object.defineProperties, es$1 = Object.getOwnPropertyDescriptors, ar$1 = Object.getOwnPropertySymbols, ns = Object.prototype.hasOwnProperty, rs = Object.prototype.propertyIsEnumerable, ur$1 = (t, e, n) => e in t ? Qi(t, e, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var Es$1 = (t, e) => {
	function n(r, ...o) {
		if (tt$2(r), t.nonceLength !== void 0) {
			const l = o[0];
			if (!l) throw new Error("nonce / iv required");
			t.varSizeNonce ? tt$2(l) : tt$2(l, t.nonceLength);
		}
		const i = t.tagLength;
		i && o[1] !== void 0 && tt$2(o[1]);
		const s = e(r, ...o), c = (l, f) => {
			if (f !== void 0) {
		...
		return {
			encrypt(l, f) {
				...
				return a = !0, tt$2(l), c(s.encrypt.length, f), s.encrypt(l, f);
			},
			decrypt(l, f) {
				if (tt$2(l), i && l.length < i) throw new Error("invalid ciphertext length: smaller than tagLength=" + i);
...
function Ns$1(t, e) {
	...
	return Fe$2(o), Fe$2(s), Ar$1(i), Ar$1(n), (c, a, u, l, f = 0) => {
		tt$2(c), tt$2(a), tt$2(u);
		const h = u.length;
		if (l === void 0 && (l = new Uint8Array(h)), tt$2(l), Fe$2(f), f < 0 || f >= Ur$1) throw new Error("arx: counter overflow");
...
var F$3 = (t, e) => t[e++] & 255 | (t[e++] & 255) << 8;
var Us = class {
	constructor(e) {
		this.blockLen = 16, this.outputLen = 16, this.buffer = new Uint8Array(16), this.r = new Uint16Array(10), this.h = new Uint16Array(10), this.pad = new Uint16Array(8), this.pos = 0, this.finished = !1, e = ze$2(e), tt$2(e, 32);
...
var q$2 = BigInt(0), H$2 = BigInt(1), At$2 = BigInt(2), nc = BigInt(3), en = BigInt(4), Mr$1 = BigInt(5), Dr$1 = BigInt(8);
function X$2(t, e) {
	const n = t % e;
	return n >= q$2 ? n : e + n;
}
...
function rc(t) {
	const e = (t - H$2) / At$2;
	let n, r, o;
	for (n = t - H$2, r = 0; n % At$2 === q$2; n /= At$2, r++);
	for (o = At$2; o < t && Hr$1(o, e, t) !== t - H$2; o++) if (o > 1e3) throw new Error("Cannot find square root: likely non-prime P");
	if (r === 1) {
		const s = (t + H$2) / en;
		return function(a, u) {
			const l = a.pow(u, s);
...
function uc(t, e, n = !1) {
	...
	const c = X$2(n ? ee$2(t) : Ot$2(t), e - H$2) + H$2;
...
function Ac(t) {
	...
	function a(p) {
		...
		return m && (N = X$2(N, O)), ft$2("private key", N, K$2, O), N;
	}
	function u(p) {
	...
	class h {
		...
		multiplyUnsafe(d) {
			...
			for (; $ > dt$2 || A > dt$2;) $ & K$2 && (T = T.add(L)), A & K$2 && (S = S.add(L)), L = L.double(), $ >>= K$2, A >>= K$2;
		...
		multiplyAndAddUnsafe(d, v, m) {
			const O = h.BASE, N = (B, A) => A === dt$2 || A === K$2 || !B.equals(O) ? B.multiplyUnsafe(A) : B.multiply(A), $ = N(this, v).add(N(d, m));
			return $.is0() ? void 0 : $;
		}
		toAffine(d) {
			return l(this, d);
		...
		clearCofactor() {
			...
			return d === K$2 ? this : v ? v(h, this) : this.multiplyUnsafe(e.h);
		}
		toRawBytes(d = !0) {
...
function Ic(t) {
	...
	const { ProjectivePoint: a, normPrivateKeyToScalar: u, weierstrassEquation: l, isWithinCurveOrder: f } = Ac({
		...
		fromBytes(g) {
			...
			if (w === o && (b === 2 || b === 3)) {
				const R = Ot$2(I);
				if (!Ee$3(R, K$2, n.ORDER)) throw new Error("Point is not on curve");
				const x = l(R);
				let C;
				try {
					C = n.sqrt(x);
	...
	class d {
		...
		assertValidity() {
			ft$2("r", this.r, K$2, r), ft$2("s", this.s, K$2, r);
		}
		addRecoveryBit(w) {
	...
	function S(g, w, b = L) {
		...
		x ??= !0, g = et$2("msgHash", g), Jr$1(b), C && (g = et$2("prehashed msgHash", I(g)));
		...
		function st(W) {
			...
			if (Zt === dt$2) return;
			let Ut = (zt.x === vt ? 0 : 2) | Number(zt.y & K$2), vn = Zt;
...
var to$1 = Kr$1(BigInt("0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff")), _c = Uc({
	...
	h: BigInt(1),
	lowS: !1
}, Qt$2), ln$1 = "base10", G$2 = "base16", qt$1 = "base64pad", xe$1 = "base64url", Kt$2 = "utf8", $c = 0, eo$1 = 1, oe$1 = 12, hn$1 = 32;
function Lc() {
	const t = fn$1.utils.randomPrivateKey(), e = fn$1.getPublicKey(t);
	return {
		privateKey: toString(t, G$2),
		publicKey: toString(e, G$2)
	};
}
function jc() {
	return toString(Lt$2(hn$1), G$2);
}
function Cc(t, e) {
	return toString(Vs$1(Qt$2, fn$1.getSharedSecret(fromString(t, G$2), fromString(e, G$2)), void 0, void 0, hn$1), G$2);
}
function Pc(t) {
	return toString(Qt$2(fromString(t, G$2)), G$2);
}
function kc(t) {
	return toString(Qt$2(fromString(t, Kt$2)), G$2);
}
function pn$1(t) {
...
function Vc(t) {
	...
	const n = typeof t.senderPublicKey < "u" ? fromString(t.senderPublicKey, G$2) : void 0, r = typeof t.iv < "u" ? fromString(t.iv, G$2) : Lt$2(oe$1), s = gn$1({
		type: e,
		sealed: $r$1(fromString(t.symKey, G$2), r).encrypt(fromString(t.message, Kt$2)),
		iv: r,
		senderPublicKey: n
	});
...
function Mc(t) {
	const e = fromString(t.symKey, G$2), { sealed: n, iv: r } = Se$2({
		encoded: t.encoded,
		encoding: t.encoding
	}), o = $r$1(e, r).decrypt(n);
...
function qc(t, e) {
	...
	return oo$1({
		type: Bt$2(n.type),
		senderPublicKey: typeof n.senderPublicKey < "u" ? toString(n.senderPublicKey, G$2) : void 0,
...
function ce$2(t) {
	return nt$2(t, !1) && t.includes(":") ? t.split(":").length === 2 : !1;
}
function Eo$1(t) {
	if (nt$2(t, !1) && t.includes(":")) {
		const e = t.split(":");
		if (e.length === 3) {
			const n = e[0] + ":" + e[1];
			return !!e[2] && ce$2(n);
...
function ha(t, e) {
	let n = null;
	return nt$2(t?.publicKey, !1) || (n = ht$2("MISSING_OR_INVALID", `${e} controller public key should be a string`)), n;
}
function mn$1(t) {
	let e = !0;
	return se$2(t) ? t.length && (e = t.every((n) => nt$2(n, !1))) : e = !1, e;
}
function vo$1(t, e, n) {
	let r = null;
...
function wa(t) {
	return !(!t || typeof t != "object" || !t.code || !Ae$1(t.code, !1) || !t.message || !nt$2(t.message, !1));
}
function ba(t) {
	return !(Et$2(t) || !nt$2(t.method, !1));
}
function Ea(t) {
	return !(Et$2(t) || Et$2(t.result) && Et$2(t.error) || !Ae$1(t.id, !1) || !nt$2(t.jsonrpc, !1));
}
function va(t) {
	return !(Et$2(t) || !nt$2(t.name, !1));
}
function xa(t, e) {
	return !(!ce$2(e) || !ho$1(t).includes(e));
}
function Sa(t, e, n) {
	return nt$2(n, !1) ? po$1(t, e).includes(n) : !1;
}
function Oa(t, e, n) {
	return nt$2(n, !1) ? go$1(t, e).includes(n) : !1;
}
function No$1(t, e, n) {
	let r = null;
...
var p$2 = Object.defineProperty, b$3 = (e, s, r) => s in e ? p$2(e, s, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: r
}) : e[s] = r, v$3 = (e, s, r) => b$3(e, typeof s != "symbol" ? s + "" : s, r);
var I$2 = class extends IEvents {
	constructor(s, r) {
		super(), this.core = s, this.logger = r, v$3(this, "records", /* @__PURE__ */ new Map());
	}
};
var y$2 = class {
	constructor(s, r) {
...
var P$2 = class extends IEvents {
	constructor(s, r) {
		super(), this.relayer = s, this.logger = r;
	}
};
var S$3 = class extends IEvents {
	constructor(s, r) {
...
var T$1 = Object.defineProperty, k$2 = (e, s, r) => s in e ? T$1(e, s, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: r
...
}, he$1 = "core", B$2 = `wc@2:${he$1}:`, Et$1 = {
	name: he$1,
	logger: "error"
}, It$1 = { database: ":memory:" }, Tt$1 = "crypto", ke$2 = "client_ed25519_seed", Ct = import_cjs.ONE_DAY, Pt$1 = "keychain", Ot$1 = "messages", je$1 = import_cjs.SIX_HOURS, At$1 = "publisher", $t = "relayer", C$3 = {
...
import_cjs.ONE_DAY;
var Wt$1 = "verify-api", Zs = "https://verify.walletconnect.com", Ht = "https://verify.walletconnect.org", Yt$1 = `${Ht}/v3`, Jt$1 = [Zs, Ht], Xt$1 = "echo", Zt$1 = "https://echo.walletconnect.com", G$1 = {
...
var Ee$2 = ({ name: r, prefix: e, encode: t, decode: i }) => new dr(r, e, t, i), de$1 = ({ prefix: r, name: e, alphabet: t }) => {
	...
	return n;
}, P$1 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i }) => Ee$2({
	prefix: e,
	name: r,
	encode(s) {
		return pr(s, i, t);
...
var On = Object.defineProperty, Rn = (r, e, t) => e in r ? On(r, e, {
	...
	writable: !0,
	value: t
}) : r[e] = t, W$2 = (r, e, t) => Rn(r, typeof e != "symbol" ? e + "" : e, t);
var Di = class {
	constructor(e, t) {
		this.core = e, this.logger = t, W$2(this, "keychain", /* @__PURE__ */ new Map()), W$2(this, "name", Pt$1), W$2(this, "version", "0.3"), W$2(this, "initialized", !1), W$2(this, "storagePrefix", B$2), W$2(this, "init", async () => {
			if (!this.initialized) {
...
var An = Object.defineProperty, xn = (r, e, t) => e in r ? An(r, e, {
	...
	writable: !0,
	value: t
}) : r[e] = t, S$2 = (r, e, t) => xn(r, typeof e != "symbol" ? e + "" : e, t);
var vi = class {
	constructor(e, t, i) {
		this.core = e, this.logger = t, S$2(this, "name", Tt$1), S$2(this, "keychain"), S$2(this, "randomSessionIdentifier", jc()), S$2(this, "initialized", !1), S$2(this, "init", async () => {
		...
		}), S$2(this, "getPayloadType", (s, n = qt$1) => {
			return Bt$2(Se$2({
				encoded: s,
				encoding: n
			}).type);
		}), S$2(this, "getPayloadSenderPublicKey", (s, n = qt$1) => {
			const o = Se$2({
				encoded: s,
				encoding: n
			});
...
var _i = class extends y$2 {
	constructor(e, t) {
		super(e, t), this.logger = e, this.core = t, k$1(this, "messages", /* @__PURE__ */ new Map()), k$1(this, "messagesWithoutClientAck", /* @__PURE__ */ new Map()), k$1(this, "name", Ot$1), k$1(this, "version", "0.3"), k$1(this, "initialized", !1), k$1(this, "storagePrefix", B$2), k$1(this, "init", async () => {
			if (!this.initialized) {
...
var qn = class extends m {
	constructor(e, t) {
		super(e, t), this.relayer = e, this.logger = t, V$2(this, "events", new import_events.EventEmitter()), V$2(this, "name", At$1), V$2(this, "queue", /* @__PURE__ */ new Map()), V$2(this, "publishTimeout", (0, import_cjs.toMiliseconds)(import_cjs.ONE_MINUTE)), V$2(this, "initialPublishTimeout", (0, import_cjs.toMiliseconds)(import_cjs.ONE_SECOND * 15)), V$2(this, "needsTransportRestart", !1), V$2(this, "publish", async (i, s, n) => {
			var o;
			...
			try {
				const u = new Promise(async (b) => {
					const x = ({ id: D }) => {
						g.opts.id === D && (this.removeRequestFromQueue(D), this.relayer.events.removeListener(C$3.publish, x), b(g));
					};
					this.relayer.events.on(C$3.publish, x);
					...
					try {
						await I, this.events.removeListener(C$3.publish, x);
					} catch (D) {
	...
	async rpcPublish(e) {
		...
		return this.relayer.events.emit(C$3.publish, e), this.logger.debug("Successfully Published Payload"), b;
	}
	...
	registerEventListeners() {
		this.relayer.core.heartbeat.on(r.pulse, () => {
			if (this.needsTransportRestart) {
				this.needsTransportRestart = !1, this.relayer.events.emit(C$3.connection_stalled);
				return;
			}
			this.checkQueue();
...
var Yn = Object.defineProperty, Jn = Object.defineProperties, Xn = Object.getOwnPropertyDescriptors, Ii = Object.getOwnPropertySymbols, Zn = Object.prototype.hasOwnProperty, Qn = Object.prototype.propertyIsEnumerable, We$2 = (r, e, t) => e in r ? Yn(r, e, {
	...
	return r;
}, He$1 = (r, e) => Jn(r, Xn(e)), f$1 = (r, e, t) => We$2(r, typeof e != "symbol" ? e + "" : e, t);
var Ti = class extends P$2 {
	constructor(e, t) {
		super(e, t), this.relayer = e, this.logger = t, f$1(this, "subscriptions", /* @__PURE__ */ new Map()), f$1(this, "topicMap", new Hn()), f$1(this, "events", new import_events.EventEmitter()), f$1(this, "name", Ut$1), f$1(this, "version", "0.3"), f$1(this, "pending", /* @__PURE__ */ new Map()), f$1(this, "cached", []), f$1(this, "initialized", !1), f$1(this, "storagePrefix", B$2), f$1(this, "subscribeTimeout", (0, import_cjs.toMiliseconds)(import_cjs.ONE_MINUTE)), f$1(this, "initialSubscribeTimeout", (0, import_cjs.toMiliseconds)(import_cjs.ONE_SECOND * 15)), f$1(this, "clientId"), f$1(this, "batchSubscribeTopicsLimit", 500), f$1(this, "init", async () => {
	...
	async rpcSubscribe(e, t, i) {
		var s;
		(!i || i?.transportType === Q$2.relay) && await this.restartToComplete({
			topic: e,
			id: e,
			relay: t
		});
		...
		try {
			...
			if (this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(C$3.connection_stalled), o) throw a;
		}
		return null;
	}
...
var Si = class extends d$1 {
	constructor(e) {
		...
		}), this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? E$4(e.logger, this.name) : (0, import_browser.default)(k$3({ level: e.logger || "error" })), this.messages = new _i(this.logger, e.core), this.subscriber = new Ti(this, this.logger), this.publisher = new qn(this, this.logger), this.relayUrl = e?.relayUrl || "wss://relay.walletconnect.org", this.projectId = e.projectId, ei$1() ? this.packageName = ri$1() : ni$1() && (this.bundleId = ri$1()), this.provider = {};
	}
	async init() {
	...
	async onLinkMessageEvent(e, t) {
		...
		this.events.emit(C$3.message, e), await this.recordMessageEvent(e, le$1.inbound);
	}
	async connect(e) {
		...
		for (; t < 6;) {
			try {
				...
				this.logger.debug({}, `Connecting to ${this.relayUrl}, attempt: ${t}...`), await this.createProvider(), await new Promise(async (i, s) => {
					...
					this.provider.once(L$2.disconnect, n), await yi$1(new Promise((o, a) => {
						this.provider.connect().then(o).catch(a);
					}), this.connectTimeout, `Socket stalled when trying to connect to ${this.relayUrl}`).catch((o) => {
						s(o);
					}).finally(() => {
						this.provider.off(L$2.disconnect, n), clearTimeout(this.reconnectTimeout);
					}), await new Promise(async (o, a) => {
						const c = () => {
							a(/* @__PURE__ */ new Error("Connection interrupted while trying to subscribe"));
						};
						this.provider.once(L$2.disconnect, c), await this.subscriber.start().then(o).catch(a).finally(() => {
							this.provider.off(L$2.disconnect, c);
						});
	...
	async createProvider() {
		...
		this.provider = new o(new f$3(si$1({
			sdkVersion: _e$2,
	...
	async onMessageEvent(e) {
		await this.shouldIgnoreMessageEvent(e) || (await this.recordMessageEvent(e, le$1.inbound), this.events.emit(C$3.message, e));
	}
	...
	async onProviderDisconnect() {
		clearTimeout(this.pingTimeout), this.events.emit(C$3.disconnect), this.connectionAttemptInProgress = !1, !this.reconnectInProgress && (this.reconnectInProgress = !0, await this.subscriber.stop(), this.subscriber.hasAnyTopics && (this.transportExplicitlyClosed || (this.reconnectTimeout = setTimeout(async () => {
...
var zi = class extends f$2 {
	constructor(e, t, i, s = B$2, n = void 0) {
		super(e, t, i, s), this.core = e, this.logger = t, this.name = i, z$1(this, "map", /* @__PURE__ */ new Map()), z$1(this, "version", "0.3"), z$1(this, "cached", []), z$1(this, "initialized", !1), z$1(this, "getKey"), z$1(this, "storagePrefix", B$2), z$1(this, "recentlyDeleted", []), z$1(this, "recentlyDeletedLimit", 200), z$1(this, "init", async () => {
		...
		}), z$1(this, "get", (o) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({
			type: "method",
			method: "get",
			key: o
		}), this.getData(o))), z$1(this, "getAll", (o) => (this.isInitialized(), o ? this.values.filter((a) => Object.keys(o).every((c) => Ao(a[c], o[c]))) : this.values)), z$1(this, "update", async (o, a) => {
...
var zo = Object.defineProperty, Lo = (r, e, t) => e in r ? zo(r, e, {
	...
	writable: !0,
	value: t
}) : r[e] = t, p$1 = (r, e, t) => Lo(r, typeof e != "symbol" ? e + "" : e, t);
var Li = class {
	constructor(e, t) {
		this.core = e, this.logger = t, p$1(this, "name", Mt$1), p$1(this, "version", "0.3"), p$1(this, "events", new import_events.default()), p$1(this, "pairings"), p$1(this, "initialized", !1), p$1(this, "storagePrefix", B$2), p$1(this, "ignoredPayloadTypes", [1]), p$1(this, "registeredMethods", []), p$1(this, "init", async () => {
			this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = !0, this.logger.trace("Initialized"));
		}), p$1(this, "register", ({ methods: i }) => {
			this.isInitialized(), this.registeredMethods = [...new Set([...this.registeredMethods, ...i])];
		}), p$1(this, "create", async (i) => {
			this.isInitialized();
			...
			if (this.pairings.keys.includes(n)) {
				if (l = this.pairings.get(n), s.addTrace(G$1.existing_pairing), l.active) throw s.setError(Y$2.active_pairing_already_exists), /* @__PURE__ */ new Error(`Pairing already exists: ${n}. Please try again with a new connection URI.`);
		...
		}), p$1(this, "activate", async ({ topic: i }) => {
			this.isInitialized();
		...
		}), p$1(this, "updateExpiry", async ({ topic: i, expiry: s }) => {
			this.isInitialized(), await this.pairings.update(i, { expiry: s });
		}), p$1(this, "updateMetadata", async ({ topic: i, metadata: s }) => {
			this.isInitialized(), await this.pairings.update(i, { peerMetadata: s });
		}), p$1(this, "getPairings", () => (this.isInitialized(), this.pairings.values)), p$1(this, "disconnect", async (i) => {
		...
		}), p$1(this, "formatUriFromPairing", (i) => {
			this.isInitialized();
		...
		}), p$1(this, "sendRequest", async (i, s, n) => {
		...
		}), p$1(this, "sendResult", async (i, s, n) => {
		...
		}), p$1(this, "sendError", async (i, s, n) => {
			...
			await this.core.relayer.publish(s, a, h), await this.core.history.resolve(o);
		}), p$1(this, "deletePairing", async (i, s) => {
		...
		}), p$1(this, "onRelayEventRequest", async (i) => {
		...
		}), p$1(this, "onRelayEventResponse", async (i) => {
		...
		}), p$1(this, "onPairingPingRequest", async (i, s) => {
			const { id: n } = s;
			try {
		...
		}), p$1(this, "onPairingPingResponse", (i, s) => {
			const { id: n } = s;
			setTimeout(() => {
		...
		}), p$1(this, "onPairingDeleteRequest", async (i, s) => {
			const { id: n } = s;
			try {
		...
		}), p$1(this, "onUnknownRpcMethodRequest", async (i, s) => {
		...
		}), p$1(this, "isValidDisconnect", async (i) => {
			if (!ma(i)) {
			...
			const { topic: s } = i;
			await this.isValidPairingTopic(s);
		}), p$1(this, "isValidPairingTopic", async (i) => {
			if (!nt$2(i, !1)) {
...
var ki = class extends I$2 {
	constructor(e, t) {
		super(e, t), this.core = e, this.logger = t, O$1(this, "records", /* @__PURE__ */ new Map()), O$1(this, "events", new import_events.EventEmitter()), O$1(this, "name", Bt$1), O$1(this, "version", "0.3"), O$1(this, "cached", []), O$1(this, "initialized", !1), O$1(this, "storagePrefix", B$2), O$1(this, "init", async () => {
	...
	cleanup() {
		try {
			...
			this.records.forEach((t) => {
				(0, import_cjs.toMiliseconds)(t.expiry || 0) - Date.now() <= 0 && (this.logger.info(`Deleting expired history log: ${t.id}`), this.records.delete(t.id), this.events.emit(F$2.deleted, t, !1), e = !0);
			}), e && this.persist();
		} catch (e) {
			this.logger.warn(e);
		}
...
var Uo = Object.defineProperty, Fo = (r, e, t) => e in r ? Uo(r, e, {
	...
	writable: !0,
	value: t
}) : r[e] = t, A$2 = (r, e, t) => Fo(r, typeof e != "symbol" ? e + "" : e, t);
var ji = class extends S$3 {
	constructor(e, t) {
		super(e, t), this.core = e, this.logger = t, A$2(this, "expirations", /* @__PURE__ */ new Map()), A$2(this, "events", new import_events.EventEmitter()), A$2(this, "name", qt), A$2(this, "version", "0.3"), A$2(this, "cached", []), A$2(this, "initialized", !1), A$2(this, "storagePrefix", B$2), A$2(this, "init", async () => {
			...
			this.expirations.set(n, o), this.checkExpiry(n, o), this.events.emit(M$2.created, {
				target: n,
				expiration: o
			});
		}), A$2(this, "get", (i) => {
			...
			if (this.isInitialized(), this.has(i)) {
				...
				this.expirations.delete(s), this.events.emit(M$2.deleted, {
					target: s,
					expiration: n
				});
			}
	...
	expire(e, t) {
		this.expirations.delete(e), this.events.emit(M$2.expired, {
			target: e,
			expiration: t
		});
	}
...
var Mo = Object.defineProperty, Ko = (r, e, t) => e in r ? Mo(r, e, {
	...
	writable: !0,
	value: t
}) : r[e] = t, w$1 = (r, e, t) => Ko(r, typeof e != "symbol" ? e + "" : e, t);
var Ui = class extends M$3 {
	constructor(e, t, i) {
		super(e, t, i), this.core = e, this.logger = t, this.store = i, w$1(this, "name", Wt$1), w$1(this, "abortController"), w$1(this, "isDevEnv"), w$1(this, "verifyUrlV3", Yt$1), w$1(this, "storagePrefix", B$2), w$1(this, "version", 2), w$1(this, "publicKey"), w$1(this, "fetchPromise"), w$1(this, "init", async () => {
			var s;
		...
		}), w$1(this, "fetchAttestation", async (s, n) => {
		...
		}), w$1(this, "validateAttestation", (s, n) => {
...
var qo = Object.defineProperty, Ki = Object.getOwnPropertySymbols, Go = Object.prototype.hasOwnProperty, Wo = Object.prototype.propertyIsEnumerable, Ze$2 = (r, e, t) => e in r ? qo(r, e, {
	...
	return r;
}, E$3 = (r, e, t) => Ze$2(r, typeof e != "symbol" ? e + "" : e, t);
var Bi = class extends R$3 {
	constructor(e, t, i = !0) {
		super(e, t, i), this.core = e, this.logger = t, E$3(this, "context", ei), E$3(this, "storagePrefix", B$2), E$3(this, "storageVersion", Qt$1), E$3(this, "events", /* @__PURE__ */ new Map()), E$3(this, "shouldPersist", !1), E$3(this, "init", async () => {
			if (!Ii$1()) try {
				const s = {
					eventId: Bi$1(),
					timestamp: Date.now(),
		...
		}), E$3(this, "getAppDomain", () => Pn$1().url), this.logger = E$4(t, this.context), this.telemetryEnabled = i, i ? this.restore().then(async () => {
...
var Ho = Object.defineProperty, Vi = Object.getOwnPropertySymbols, Yo = Object.prototype.hasOwnProperty, Jo = Object.prototype.propertyIsEnumerable, Qe$1 = (r, e, t) => e in r ? Ho(r, e, {
	...
	return r;
}, v$2 = (r, e, t) => Qe$1(r, typeof e != "symbol" ? e + "" : e, t);
var Xo = class Te$1 extends h$1 {
	constructor(e) {
		var t;
		super(e), v$2(this, "protocol", "wc"), v$2(this, "version", 2), v$2(this, "name", he$1), v$2(this, "relayUrl"), v$2(this, "projectId"), v$2(this, "customStoragePrefix"), v$2(this, "events", new import_events.EventEmitter()), v$2(this, "logger"), v$2(this, "heartbeat"), v$2(this, "relayer"), v$2(this, "crypto"), v$2(this, "storage"), v$2(this, "history"), v$2(this, "expirer"), v$2(this, "pairing"), v$2(this, "verify"), v$2(this, "echoClient"), v$2(this, "linkModeSupportedApps"), v$2(this, "eventClient"), v$2(this, "initialized", !1), v$2(this, "logChunkController"), v$2(this, "on", (a, c) => this.events.on(a, c)), v$2(this, "once", (a, c) => this.events.once(a, c)), v$2(this, "off", (a, c) => this.events.off(a, c)), v$2(this, "removeListener", (a, c) => this.events.removeListener(a, c)), v$2(this, "dispatchEnvelope", ({ topic: a, message: c, sessionExists: h }) => {
			if (!a || !c) return;
			const l = {
				topic: a,
				message: c,
				publishedAt: Date.now(),
				transportType: Q$2.link_mode
			};
		...
		const { logger: n, chunkLoggerController: o } = A$3({
			opts: k$3({
		...
		}), this.logger = E$4(n, this.name), this.heartbeat = new i$1(), this.crypto = new vi(this, this.logger, e?.keychain), this.history = new ki(this, this.logger), this.expirer = new ji(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h$2(qi(qi({}, It$1), e?.storageOptions)), this.relayer = new Si({
			core: this,
			logger: this.logger,
			relayUrl: this.relayUrl,
			projectId: this.projectId
...
var $e$1 = "Proposal expired", ht$1 = "session", J$1 = import_cjs.SEVEN_DAYS, dt$1 = "engine", N$1 = {
	wc_sessionPropose: {
		req: {
...
var vs = Object.defineProperty, Is = Object.defineProperties, Ts = Object.getOwnPropertyDescriptors, ft$1 = Object.getOwnPropertySymbols, qs = Object.prototype.hasOwnProperty, Ps = Object.prototype.propertyIsEnumerable, Ue$1 = (S, n, e) => n in S ? vs(S, n, {
	...
	return S;
}, b$2 = (S, n) => Is(S, Ts(n)), c = (S, n, e) => Ue$1(S, typeof n != "symbol" ? n + "" : n, e);
var Ns = class extends V$3 {
	constructor(n) {
		super(n), c(this, "name", dt$1), c(this, "events", new import_events.default()), c(this, "initialized", !1), c(this, "requestQueue", {
			...
			const d = await this.client.core.crypto.generateKeyPair(), w = N$1.wc_sessionPropose.req.ttl || import_cjs.FIVE_MINUTES, m = Ei$1(w), f = b$2(v$1(v$1({
			...
			const A = await this.client.core.crypto.generateKeyPair(), D = m.publicKey, I = await this.client.core.crypto.generateSharedKey(A, D), T = v$1(v$1(v$1({
				...
				expiry: Ei$1(J$1)
			}, p && { sessionProperties: p }), h && { scopedProperties: h }), u && { sessionConfig: u }), K = Q$2.relay;
			...
			return this.client.core.eventClient.deleteEvent({ eventId: g.eventId }), await this.client.core.pairing.updateMetadata({
				topic: w,
				metadata: m.metadata
			}), await this.client.proposal.delete(o, Nt$2("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: w }), await this.setExpiry(I, Ei$1(J$1)), {
				topic: I,
			...
			return this.events.once(xi$1("session_extend", s), ({ error: a }) => {
				a ? o(a) : r();
			}), await this.setExpiry(t, Ei$1(J$1)), this.sendRequest({
				topic: t,
			...
			if (w) return await this.sendRequest({
				...
				method: d,
				params: {
					request: b$2(v$1({}, s), { expiryTimestamp: Ei$1(r) }),
					chainId: t
				},
				expiry: r,
				throwOnFailedPublish: !0,
			...
			const T = f && f > N$1.wc_sessionAuthenticate.req.ttl ? f : N$1.wc_sessionAuthenticate.req.ttl, K = {
				...
				Te.length > 0 && (he = {
					...
					topic: g,
					metadata: Q.metadata
				}), he = this.client.session.get(se)), (L = this.client.metadata.redirect) != null && L.linkMode && (Fe = Q.metadata.redirect) != null && Fe.linkMode && (Qe = Q.metadata.redirect) != null && Qe.universal && t && (this.client.core.addLinkModeSupportedApp(Q.metadata.redirect.universal), this.client.session.update(se, { transportType: Q$2.link_mode })), je({
					auths: He,
					session: he
				});
			};
			...
			return await this.setProposal(q.id, q), await this.setAuthRequest(te, {
				request: b$2(v$1({}, K), { verifyContext: {} }),
				pairingTopic: g,
				transportType: r
			}), {
				uri: Ie ?? A,
			...
			if (f.attestation = m, r && (f.ttl = r), o && (f.id = o), this.client.core.history.set(t, u), w) {
				...
				const _ = N$1[s].req;
				r && (_.ttl = r), o && (_.id = o), _.tvf = b$2(v$1({}, h), { correlationId: u.id }), l ? (_.internal = b$2(v$1({}, _.internal), { throwOnFailedPublish: !0 }), await this.client.core.relayer.publish(t, d, _)) : this.client.core.relayer.publish(t, d, _).catch((g) => this.client.logger.error(g));
			}
			return u.id;
			...
			try {
				const w = h ? xe$1 : qt$1;
				p = await this.client.core.crypto.encode(s, l, b$2(v$1({}, o || {}), { encoding: w }));
			} catch (w) {
			...
			if (h) {
				...
				m.tvf = b$2(v$1({}, d), { correlationId: t }), r ? (m.internal = b$2(v$1({}, m.internal), { throwOnFailedPublish: !0 }), await this.client.core.relayer.publish(s, p, m)) : this.client.core.relayer.publish(s, p, m).catch((f) => this.client.logger.error(f));
			}
			...
			try {
				const d = h ? xe$1 : qt$1;
				p = await this.client.core.crypto.encode(s, l, b$2(v$1({}, r || {}), { encoding: d }));
			} catch (d) {
			...
			try {
				...
				this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l?.setError(Y$2.proposal_listener_not_found)), this.isValidConnect(v$1({}, s.params));
				const h = v$1({
					id: a,
					pairingTopic: t,
				...
				l?.addTrace(G$1.emit_session_proposal), this.client.events.emit("session_proposal", {
					id: a,
					params: h,
					verifyContext: u
				});
			...
			try {
				...
				const w = this.client.proposal.get(d.proposalId), m = b$2(v$1(v$1(v$1({
					topic: e,
					relay: r,
					expiry: a,
					namespaces: l,
				...
				}, p && { sessionProperties: p }), h && { scopedProperties: h }), u && { sessionConfig: u }), { transportType: Q$2.relay });
			...
			const { id: s } = t;
			try {
				this.isValidExtend({ topic: e }), await this.setExpiry(e, Ei$1(J$1)), await this.sendResult({
					id: s,
					topic: e,
					result: !0,
					throwOnFailedPublish: !0
			...
			try {
				await this.isValidRequest(v$1({ topic: r }, u));
			...
			try {
				...
				this.isValidEmit(v$1({ topic: e }, i)), this.client.events.emit("session_event", {
					id: s,
					topic: e,
					params: i
				}), Ra.set(r, s);
			...
			try {
				...
				await this.setAuthRequest(i.id, {
					...
					pairingTopic: s,
					transportType: a
				}), a === Q$2.link_mode && (t = l.metadata.redirect) != null && t.universal && this.client.core.addLinkModeSupportedApp(l.metadata.redirect.universal), this.client.events.emit("session_authenticate", {
					topic: s,
					params: i.params,
					id: i.id,
					verifyContext: u
			...
			t && this.onSessionProposeRequest({
				topic: e.topic,
				payload: formatJsonRpcRequest("wc_sessionPropose", b$2(v$1({}, t), {
			...
			if (!nt$2(s, !1)) throw new Error("uri is required parameter");
			if (!nt$2(i, !1)) throw new Error("domain is required parameter");
			if (!nt$2(r, !1)) throw new Error("nonce is required parameter");
			...
			i && this.client.session.update(t, { transportType: Q$2.link_mode }), this.client.core.dispatchEnvelope({
				topic: t,
				message: s,
				sessionExists: i
			});
	...
	registerRelayerEvents() {
		this.client.core.relayer.on(C$3.message, (n) => {
	...
	async onRelayMessage(n) {
		...
		try {
			const o = await this.client.core.crypto.decode(e, t, {
				receiverPublicKey: r,
				encoding: i === Q$2.link_mode ? xe$1 : qt$1
			});
...
var ks = Object.defineProperty, Ms = (S, n, e) => n in S ? ks(S, n, {
	...
	writable: !0,
	value: e
}) : S[n] = e, E$2 = (S, n, e) => Ms(S, typeof n != "symbol" ? n + "" : n, e);
var Ee$1 = class Ee$1 extends J$2 {
	constructor(n) {
		super(n), E$2(this, "protocol", "wc"), E$2(this, "version", 2), E$2(this, "name", me$1.name), E$2(this, "metadata"), E$2(this, "core"), E$2(this, "logger"), E$2(this, "events", new import_events.EventEmitter()), E$2(this, "engine"), E$2(this, "session"), E$2(this, "proposal"), E$2(this, "pendingRequest"), E$2(this, "auth"), E$2(this, "signConfig"), E$2(this, "on", (t, s) => this.events.on(t, s)), E$2(this, "once", (t, s) => this.events.once(t, s)), E$2(this, "off", (t, s) => this.events.off(t, s)), E$2(this, "removeListener", (t, s) => this.events.removeListener(t, s)), E$2(this, "removeAllListeners", (t) => this.events.removeAllListeners(t)), E$2(this, "connect", async (t) => {
			try {
...
var et$1 = "error", St = "wss://relay.walletconnect.org", U$1 = `wc@2:universal_provider:`, st$1 = "https://rpc.walletconnect.org/v1/", I$1 = "generic", jt = `${st$1}bundler`, u = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
function Rt() {}
function k(s) {
...
function ne(s, ...t) {
	...
	for (let a = 0; a < e.length; a++) {
		const r = e[a];
		n = F$1(n, r, i, /* @__PURE__ */ new Map());
	}
	return n;
}
function F$1(s, t, e, i) {
	...
	for (let a = 0; a < n.length; a++) {
		...
		m != null ? s[r] = m : Array.isArray(c) || it(o) && it(c) ? s[r] = F$1(o, c, e, i) : o == null && re(c) ? s[r] = F$1({}, c, e, i) : o == null && ie(c) ? s[r] = pt(c) : (o === void 0 || c !== void 0) && (s[r] = c);
	}
	return s;
}
function ae(s, ...t) {
...
function d(s, t, e) {
	var i;
	const n = Ne$1(s);
	return ((i = t.rpcMap) == null ? void 0 : i[n.reference]) || `${st$1}?chainId=${n.namespace}:${n.reference}&projectId=${e}`;
}
function b$1(s) {
...
function mt(s) {
	...
	for (const [c, o] of Object.entries(s)) {
		...
		}), (Oe$2(P) || Oe$2(((n = r[p]) == null ? void 0 : n.rpcMap) || {})) && (r[p].rpcMap = L$1(L$1({}, P), (a = r[p]) == null ? void 0 : a.rpcMap));
	}
	return r;
}
function vt(s) {
...
var ve = class {
	...
	createHttpProvider(t, e) {
		...
		return new o(new f$4(i, h("disableProviderPing")));
	}
};
var ge = Object.defineProperty, Pe = Object.defineProperties, we = Object.getOwnPropertyDescriptors, wt = Object.getOwnPropertySymbols, ye = Object.prototype.hasOwnProperty, be = Object.prototype.propertyIsEnumerable, X$1 = (s, t, e) => t in s ? ge(s, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: e
...
var Ie = class {
	constructor(t) {
		A$1(this, "name", "eip155"), A$1(this, "client"), A$1(this, "chainId"), A$1(this, "namespace"), A$1(this, "httpProviders"), A$1(this, "events"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.httpProviders = this.createHttpProviders(), this.chainId = parseInt(this.getDefaultChain());
	}
	async request(t) {
...
var $e = Object.defineProperty, Oe = (s, t, e) => t in s ? $e(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, C$1 = (s, t, e) => Oe(s, typeof t != "symbol" ? t + "" : t, e);
var Ae = class {
	constructor(t) {
		C$1(this, "name", "solana"), C$1(this, "client"), C$1(this, "httpProviders"), C$1(this, "events"), C$1(this, "namespace"), C$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
...
var Ce = Object.defineProperty, He = (s, t, e) => t in s ? Ce(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, H$1 = (s, t, e) => He(s, typeof t != "symbol" ? t + "" : t, e);
var Ee = class {
	constructor(t) {
		H$1(this, "name", "cosmos"), H$1(this, "client"), H$1(this, "httpProviders"), H$1(this, "events"), H$1(this, "namespace"), H$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
...
var Ne = Object.defineProperty, Se = (s, t, e) => t in s ? Ne(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, E$1 = (s, t, e) => Se(s, typeof t != "symbol" ? t + "" : t, e);
var De = class {
	constructor(t) {
		E$1(this, "name", "algorand"), E$1(this, "client"), E$1(this, "httpProviders"), E$1(this, "events"), E$1(this, "namespace"), E$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
	...
	createHttpProvider(t, e) {
		const i = e || d(t, this.namespace, this.client.core.projectId);
		return typeof i > "u" ? void 0 : new o(new f$4(i, h("disableProviderPing")));
	}
};
...
var Re = class {
	...
	createHttpProviders() {
		const t = {};
		return this.namespace.chains.forEach((e) => {
			const i = this.getCardanoRPCUrl(e), n = b$1(e);
...
var _e = Object.defineProperty, Ue = (s, t, e) => t in s ? _e(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, S$1 = (s, t, e) => Ue(s, typeof t != "symbol" ? t + "" : t, e);
var Fe = class {
	constructor(t) {
		S$1(this, "name", "elrond"), S$1(this, "client"), S$1(this, "httpProviders"), S$1(this, "events"), S$1(this, "namespace"), S$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
...
var Le = Object.defineProperty, Me = (s, t, e) => t in s ? Le(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, D$1 = (s, t, e) => Me(s, typeof t != "symbol" ? t + "" : t, e);
var xe = class {
	constructor(t) {
		D$1(this, "name", "multiversx"), D$1(this, "client"), D$1(this, "httpProviders"), D$1(this, "events"), D$1(this, "namespace"), D$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
...
var Be = Object.defineProperty, Ge = (s, t, e) => t in s ? Be(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, q$1 = (s, t, e) => Ge(s, typeof t != "symbol" ? t + "" : t, e);
var Je = class {
	constructor(t) {
		q$1(this, "name", "near"), q$1(this, "client"), q$1(this, "httpProviders"), q$1(this, "events"), q$1(this, "namespace"), q$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
...
var ze = Object.defineProperty, ke = (s, t, e) => t in s ? ze(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, j$1 = (s, t, e) => ke(s, typeof t != "symbol" ? t + "" : t, e);
var We = class {
	constructor(t) {
		j$1(this, "name", "tezos"), j$1(this, "client"), j$1(this, "httpProviders"), j$1(this, "events"), j$1(this, "namespace"), j$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
		this.namespace = Object.assign(this.namespace, t);
	}
	...
	createHttpProvider(t, e) {
		const i = e || d(t, this.namespace);
		return typeof i > "u" ? void 0 : new o(new f$4(i));
	}
};
var Ke = Object.defineProperty, Ve = (s, t, e) => t in s ? Ke(s, t, {
	...
	writable: !0,
	value: e
}) : s[t] = e, R$1 = (s, t, e) => Ve(s, typeof t != "symbol" ? t + "" : t, e);
var Xe = class {
	constructor(t) {
		R$1(this, "name", I$1), R$1(this, "client"), R$1(this, "httpProviders"), R$1(this, "events"), R$1(this, "namespace"), R$1(this, "chainId"), this.namespace = t.namespace, this.events = h("events"), this.client = h("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
	}
	updateNamespace(t) {
...
var Ye = Object.defineProperty, Qe = Object.defineProperties, Ze = Object.getOwnPropertyDescriptors, It = Object.getOwnPropertySymbols, Te = Object.prototype.hasOwnProperty, ts = Object.prototype.propertyIsEnumerable, Y$1 = (s, t, e) => t in s ? Ye(s, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: e
}) : s[t] = e, x = (s, t) => {
	for (var e in t || (t = {})) Te.call(t, e) && Y$1(s, e, t[e]);
	if (It) for (var e of It(t)) ts.call(t, e) && Y$1(s, e, t[e]);
	return s;
}, Q$1 = (s, t) => Qe(s, Ze(t)), l = (s, t, e) => Y$1(s, typeof t != "symbol" ? t + "" : t, e);
var es = class B$1 {
	constructor(t) {
		l(this, "client"), l(this, "namespaces"), l(this, "optionalNamespaces"), l(this, "sessionProperties"), l(this, "scopedProperties"), l(this, "events", new import_events.default()), l(this, "rpcProviders", {}), l(this, "session"), l(this, "providerOpts"), l(this, "logger"), l(this, "uri"), l(this, "disableProviderPing", !1), this.providerOpts = t, this.logger = typeof t?.logger < "u" && typeof t?.logger != "string" ? t.logger : (0, import_browser.default)(k$3({ level: t?.logger || et$1 })), this.disableProviderPing = t?.disableProviderPing || !1;
	}
	static async init(t) {
		const e = new B$1(t);
		return await e.initialize(), e;
	...
	async authenticate(t, e) {
		...
		if (this.session = a.session, this.session) {
			...
			this.namespaces = M$1(this.namespaces, r), await this.persist("namespaces", this.namespaces), this.onConnect();
		}
		return a;
	}
	on(t, e) {
	...
	async pair(t) {
		...
		return this.namespaces = M$1(this.namespaces, a), await this.persist("namespaces", this.namespaces), await this.persist("optionalNamespaces", this.optionalNamespaces), this.onConnect(), this.session;
	}
	setDefaultChain(t, e) {
		try {
			if (!this.session) return;
			const [i, n] = this.validateChain(t), a = this.getProvider(i);
			a.name === I$1 ? a.setDefaultChain(`${i}:${n}`, e) : a.setDefaultChain(n, e);
		} catch (i) {
	...
	async createClient() {
		...
		if (this.client = this.providerOpts.client || await Ee$1.init({
			...
			logger: this.providerOpts.logger || et$1,
	...
	createProviders() {
		...
		V$1("client", this.client), V$1("events", this.events), V$1("disableProviderPing", this.disableProviderPing), t.forEach((e) => {
			if (!this.session) return;
			const i = le(e, this.session), n = ft(i), r = Q$1(x({}, M$1(this.namespaces, this.optionalNamespaces)[e]), {
				accounts: i,
				chains: n
			});
			switch (e) {
				...
				case "tezos":
					...
					break;
				default: this.rpcProviders[I$1] ? this.rpcProviders[I$1].updateNamespace(r) : this.rpcProviders[I$1] = new Xe({ namespace: r });
			}
		});
	}
	registerEventListeners() {
		...
		this.client.on("session_ping", (t) => {
			...
			if (a.name === "accountsChanged") {
				...
				const r = i.chainId, c = i.event.data, o = yo$1(r), m = K$1(r) !== K$1(c) ? `${o}:${K$1(c)}` : r;
			...
			this.session = Q$1(x({}, (n = this.client) == null ? void 0 : n.session.get(t)), { namespaces: a }), this.onSessionUpdate(), this.events.emit("session_update", {
				topic: t,
				params: e
			});
		}), this.client.on("session_delete", async (t) => {
			var e;
			t.topic === ((e = this.session) == null ? void 0 : e.topic) && (await this.cleanup(), this.events.emit("session_delete", t), this.events.emit("disconnect", Q$1(x({}, Nt$2("USER_DISCONNECTED")), { data: t.topic })));
	...
	setNamespaces(t) {
		...
		this.optionalNamespaces = M$1(e, i), this.sessionProperties = n, this.scopedProperties = a;
	}
	validateChain(t) {
		const [e, i] = t?.split(":") || ["", ""];
	...
	async persist(t, e) {
		...
		await this.client.core.storage.setItem(`${U$1}/${t}${n}`, e);
	}
	async getFromStore(t) {
		var e;
		const i = ((e = this.session) == null ? void 0 : e.topic) || "";
		return await this.client.core.storage.getItem(`${U$1}/${t}${i}`);
	}
	async deleteFromStore(t) {
		var e;
		const i = ((e = this.session) == null ? void 0 : e.topic) || "";
		await this.client.core.storage.removeItem(`${U$1}/${t}${i}`);
	}
	async cleanupStorage() {
		...
		try {
			...
			for (const i of e) i.startsWith(U$1) && await this.client.core.storage.removeItem(i);
		} catch (e) {
...
//#endregion
//#region node_modules/@walletconnect/ethereum-provider/dist/index.es.js
var q = `wc@2:ethereum_provider:`, U = "https://rpc.walletconnect.org/v1/", f = ["eth_sendTransaction", "personal_sign"], A = [
	...
	const { createAppKit: s } = await import("./core-CVu5YgwV.js");
	return s;
};
...
var Y = class b {
	...
	async connect(t) {
		...
		try {
			const a = await new Promise(async (u, c) => {
				...
				await this.signer.connect(w(v({ namespaces: v({}, n && { [this.namespace]: n }) }, i && { optionalNamespaces: { [this.namespace]: i } }), {
			...
			if (!a) return;
			const o = Ko$1(a.namespaces, [this.namespace]);
			this.setChainIds(this.rpc.chains.length ? this.rpc.chains : o), this.setAccounts(o), this.events.emit("connect", { chainId: E(this.chainId) });
		} catch (a) {
	...
	async authenticate(t, e) {
		...
		try {
			const i = await new Promise(async (o, u) => {
				...
				})), await this.signer.authenticate(w(v({}, t), { chains: this.rpc.chains }), e).then((r) => {
					o(r);
				}).catch((r) => {
					var m;
	...
	registerEventListeners() {
		this.signer.on("session_event", (t) => {
			...
			this.chainId = parseInt(t), this.events.emit("chainChanged", E(this.chainId)), this.persist();
		}), this.signer.on("session_update", (t) => {
			this.events.emit("session_update", t);
		}), this.signer.on("session_delete", (t) => {
			this.reset(), this.events.emit("session_delete", t), this.events.emit("disconnect", w(v({}, Nt$2("USER_DISCONNECTED")), {
				data: t.topic,
	...
	async initialize(t) {
		if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? I(this.rpc.chains) : I(this.rpc.optionalChains), this.signer = await es.init({
			...
			try {
				...
				throw console.warn(n), /* @__PURE__ */ new Error("To use QR modal, please install @reown/appkit package");
			}
			if (e) try {
				this.modal = e;
			} catch (n) {
				throw this.signer.logger.error(n), /* @__PURE__ */ new Error("Could not generate WalletConnectModal Instance");
			}
		}
	}
	loadConnectOpts(t) {
		...
		e && se$2(e) && (this.rpc.chains = e.map((a) => this.formatChainId(a)), e.forEach((a) => {
			this.rpc.rpcMap[a] = i?.[a] || this.getRpcUrl(a);
		})), n && se$2(n) && (this.rpc.optionalChains = [], this.rpc.optionalChains = n?.map((a) => this.formatChainId(a)), n.forEach((a) => {
			this.rpc.rpcMap[a] = i?.[a] || this.getRpcUrl(a);
		}));
	}
	getRpcUrl(t, e) {
...
//#endregion
export { Y as EthereumProvider };

//# sourceMappingURL=index.es-rjQ5MhiY.js.map