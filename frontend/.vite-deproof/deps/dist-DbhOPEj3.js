import { n as __esmMin, o as __toCommonJS, r as __exportAll, t as __commonJSMin } from "./chunk-t8Qwt55I.js";
import { t as require_eventemitter3 } from "./eventemitter3--nuI5ZCb.js";
import { a as tslib_es6_exports, i as init_tslib_es6 } from "./tslib.es6-B6zPSILH.js";
...
import { c as init_preact_module, i as init_hooks_module, r as hooks_module_exports, u as preact_module_exports } from "./hooks.module-5GJgYZAT.js";
import { t as require_events } from "./events-D4qtS2eh.js";
//#region node_modules/cbw-sdk/dist/assets/wallet-logo.js
var require_wallet_logo = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/constants.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/error/constants.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/error/utils.js
var require_utils$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function getMessageFromCode(code, fallbackMessage = FALLBACK_MESSAGE) {
		if (code && Number.isInteger(code)) {
			...
			if (hasKey(constants_1.errorValues, codeString)) return constants_1.errorValues[codeString].message;
	...
	*/
	function isValidCode(code) {
		...
		const codeString = code.toString();
		if (constants_1.errorValues[codeString]) return true;
	...
	*/
	function getErrorCode(error) {
		...
		else if (isErrorWithCode(error)) return (_a = error.code) !== null && _a !== void 0 ? _a : error.errorCode;
	}
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/error/errors.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/type/Web3Response.js
var require_Web3Response = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/version.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/error/serialize.js
var require_serialize = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function serializeError(error, requestOrMethod) {
		const serialized = (0, utils_1.serialize)(getErrorObject(error), { shouldIncludeStack: true });
		...
		if (method) docUrl.searchParams.set("method", method);
	...
	*/
	function getErrorObject(error) {
		...
		else if ((0, Web3Response_1.isErrorResponse)(error)) return Object.assign(Object.assign({}, error), {
	...
	*/
	function getMethod(serializedData, request) {
		...
		if (methodInData) return methodInData;
		if (request === void 0) return;
		else if (typeof request === "string") return request;
		else if (!Array.isArray(request)) return request.method;
		else if (request.length > 0) return request[0].method;
	}
}));
//#endregion
//#region node_modules/cbw-sdk/dist/core/error/index.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/type.js
var require_type$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/core/util.js
	...
	*/
	...
	function ensureHexString(hex, includePrefix = false) {
		if (typeof hex === "string") {
			const s = strip0x(hex).toLowerCase();
			if (HEXADECIMAL_STRING_REGEX.test(s)) return (0, type_1.HexString)(includePrefix ? `0x${s}` : s);
		}
	...
	function ensureEvenLengthHexString(hex, includePrefix = false) {
		...
		if (h.length % 2 === 1) h = (0, type_1.HexString)(`0${h}`);
	...
	function ensureAddressString(str) {
		if (typeof str === "string") {
			...
			if (isHexString(s) && s.length === 40) return (0, type_1.AddressString)(prepend0x(s));
		}
	...
	function ensureIntNumber(num) {
		if (typeof num === "number" && Number.isInteger(num)) return (0, type_1.IntNumber)(num);
		if (typeof num === "string") {
			if (INT_STRING_REGEX.test(num)) return (0, type_1.IntNumber)(Number(num));
			if (isHexString(num)) return (0, type_1.IntNumber)(new bn_js_1.default(ensureEvenLengthHexString(num, false), 16).toNumber());
		}
		throw error_1.standardErrors.rpc.invalidParams(`Not an integer: ${String(num)}`);
	}
	exports.ensureIntNumber = ensureIntNumber;
	function ensureRegExpString(regExp) {
		if (regExp instanceof RegExp) return (0, type_1.RegExpString)(regExp.toString());
	...
	function getFavicon() {
		...
		if (!href || href.startsWith("javascript:") || href.startsWith("vbscript:")) return null;
	...
	function createQrUrl(sessionId, sessionSecret, serverUrl, isParentConnection, version, chainId) {
		...
		return `${serverUrl}/#/link?${new URLSearchParams({
...
//#endregion
//#region node_modules/cbw-sdk/dist/lib/ScopedLocalStorage.js
var require_ScopedLocalStorage = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/provider/DiagnosticLogger.js
var require_DiagnosticLogger = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/RelayAbstract.js
var require_RelayAbstract = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var RelayAbstract = class {
		async makeEthereumJSONRPCRequest(request, jsonRpcUrl) {
			...
			return window.fetch(jsonRpcUrl, {
				...
				if (!json) throw error_1.standardErrors.rpc.parse({});
				const response = json;
				const { error } = response;
				if (error) throw (0, error_1.serializeError)(error, request.method);
				return response;
			});
		}
	};
...
//#endregion
//#region node_modules/typed-array-buffer/index.js
...
//#endregion
//#region node_modules/to-buffer/index.js
...
//#endregion
//#region node_modules/sha.js/hash.js
...
//#endregion
//#region node_modules/sha.js/sha.js
...
//#endregion
//#region node_modules/sha.js/sha1.js
...
//#endregion
//#region node_modules/sha.js/sha256.js
...
//#endregion
//#region node_modules/sha.js/sha224.js
...
//#endregion
//#region node_modules/sha.js/sha512.js
...
//#endregion
//#region node_modules/sha.js/sha384.js
...
//#endregion
//#region node_modules/sha.js/index.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/Session.js
var require_Session = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Session = void 0;
	var sha_js_1 = require_sha_js();
...
//#endregion
//#region node_modules/cbw-sdk/dist/lib/Cipher.js
var require_Cipher = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/connection/WalletLinkHTTP.js
var require_WalletLinkHTTP = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/connection/WalletLinkWebSocket.js
var require_WalletLinkWebSocket = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/connection/WalletLinkConnection.js
var require_WalletLinkConnection = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var WalletLinkConnection = class {
		...
		constructor({ session, linkAPIUrl, listener, diagnostic, WebSocketClass = WebSocket }) {
			...
			*/
			...
			this.handleDestroyed = (__destroyed) => {
				...
				(_b = this.diagnostic) === null || _b === void 0 || _b.log(DiagnosticLogger_1.EVENTS.METADATA_DESTROYED, {
			...
			this.handleAccountUpdated = async (encryptedEthereumAddress) => {
				...
				try {
					...
					(_b = this.diagnostic) === null || _b === void 0 || _b.log(DiagnosticLogger_1.EVENTS.GENERAL_ERROR, {
			...
			ws.setConnectionStateListener(async (state) => {
				var _a;
				(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.CONNECTED_STATE_CHANGE, {
					state,
				...
				switch (state) {
					...
					case WalletLinkWebSocket_1.ConnectionState.CONNECTED:
						...
						break;
					case WalletLinkWebSocket_1.ConnectionState.CONNECTING: break;
				}
			...
			ws.setIncomingDataListener((m) => {
				...
				switch (m.type) {
					...
					case "Linked": {
						...
						(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.LINKED, {
							sessionIdHash: Session_1.Session.hash(session.id),
							linked,
							type: m.type,
					...
					case "SessionConfigUpdated":
						(_b = this.diagnostic) === null || _b === void 0 || _b.log(DiagnosticLogger_1.EVENTS.SESSION_CONFIG_RECEIVED, {
							sessionIdHash: Session_1.Session.hash(session.id),
				...
				if (m.id !== void 0) (_c = this.requestResolutions.get(m.id)) === null || _c === void 0 || _c(m);
			});
			this.ws = ws;
		...
		*/
		connect() {
			...
			(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.STARTED_CONNECTING, { sessionIdHash: Session_1.Session.hash(this.session.id) });
			this.ws.connect();
		}
		/**
		...
		*/
		destroy() {
			...
			this.destroyed = true;
			this.ws.disconnect();
			(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.DISCONNECTED, { sessionIdHash: Session_1.Session.hash(this.session.id) });
		...
		set connected(connected) {
			...
			if (connected) (_a = this.onceConnected) === null || _a === void 0 || _a.call(this);
			(_b = this.listener) === null || _b === void 0 || _b.connectedUpdated(connected);
		}
		setOnceConnected(callback) {
			return new Promise((resolve) => {
				if (this.connected) callback().then(resolve);
				else this.onceConnected = () => {
		...
		async handleIncomingEvent(m) {
			...
			try {
				...
				(_a = this.listener) === null || _a === void 0 || _a.handleWeb3ResponseMessage(message);
			} catch (_c) {
				(_b = this.diagnostic) === null || _b === void 0 || _b.log(DiagnosticLogger_1.EVENTS.GENERAL_ERROR, {
					message: "Had error decrypting",
					value: "incomingEvent"
		...
		*/
		async setSessionMetadata(key, value) {
			...
			return this.setOnceConnected(async () => {
				...
				if (res.type === "Fail") throw new Error(res.error || "failed to set session metadata");
			});
		}
		/**
		...
		*/
		...
		async authenticate() {
			...
			if (res.type === "Fail") throw new Error(res.error || "failed to authentcate");
		}
		sendIsLinked() {
			const m = {
				type: "IsLinked",
...
//#endregion
//#region node_modules/cbw-sdk/dist/lib/cssReset-css.js
var require_cssReset_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/lib/cssReset.js
var require_cssReset = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/node_modules/clsx/dist/clsx.m.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/CloseIcon.js
var require_CloseIcon = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function CloseIcon(props) {
		...
		}, props), (0, preact_1.h)("path", { d: "M13.7677 13L12.3535 14.4142L18.3535 20.4142L12.3535 26.4142L13.7677 27.8284L19.7677 21.8284L25.7677 27.8284L27.1819 26.4142L21.1819 20.4142L27.1819 14.4142L25.7677 13L19.7677 19L13.7677 13Z" }));
	}
	exports.CloseIcon = CloseIcon;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/CoinbaseWalletRound.js
var require_CoinbaseWalletRound = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/QRCodeIcon.js
var require_QRCodeIcon = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function QRCodeIcon(props) {
		return (0, preact_1.h)("svg", Object.assign({
			...
			viewBox: "0 0 24 24",
			xmlns: "http://www.w3.org/2000/svg"
		}, props), (0, preact_1.h)("path", { d: "M3 3V8.99939L5 8.99996V5H9V3H3Z" }), (0, preact_1.h)("path", { d: "M15 21L21 21V15.0006L19 15V19L15 19V21Z" }), (0, preact_1.h)("path", { d: "M21 9H19V5H15.0006L15 3H21V9Z" }), (0, preact_1.h)("path", { d: "M3 15V21H8.99939L8.99996 19H5L5 15H3Z" }));
	}
	exports.QRCodeIcon = QRCodeIcon;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/vendor-js/qrcode-svg/index.js
var require_qrcode_svg = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* @fileoverview
	...
	*/
	...
	function QRCode(options) {
		...
		function _getErrorCorrectLevel(ecl) {
			switch (ecl) {
				...
				default: throw new Error("Unknwon error correction level: " + ecl);
			}
		}
		...
		this.qrcode = new QRCodeModel(_getTypeNumber(content, this.options.ecl), _getErrorCorrectLevel(this.options.ecl));
	...
	QRCode.prototype.svg = function(opt) {
		...
		var modrect = "";
		var pathdata = "";
		for (var y = 0; y < length; y++) for (var x = 0; x < length; x++) if (modules[x][y]) {
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/QRCode.js
var require_QRCode = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var QRCode = (props) => {
		...
		(0, hooks_1.useEffect)(() => {
			...
			setSvg(`data:image/svg+xml;base64,${Buffer.from(qrcode.svg(), "utf8").toString("base64")}`);
		}, [
			props.bgColor,
			props.content,
			props.fgColor,
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Spinner/Spinner-css.js
var require_Spinner_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Spinner/Spinner.js
var require_Spinner = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Spinner = (props) => {
		...
		return (0, preact_1.h)("div", { class: "-cbwsdk-spinner" }, (0, preact_1.h)("style", null, Spinner_css_1.default), (0, preact_1.h)("svg", {
			viewBox: "0 0 100 100",
			xmlns: "http://www.w3.org/2000/svg",
			style: {
				width: size,
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/ConnectContent/ConnectContent-css.js
var require_ConnectContent_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/ConnectContent/ConnectContent.js
var require_ConnectContent = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function ConnectContent(props) {
		...
		return (0, preact_1.h)("div", {
		...
		}, (0, preact_1.h)("style", null, ConnectContent_css_1.default), (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-header" }, (0, preact_1.h)("h2", { className: (0, clsx_1.default)("-cbwsdk-connect-content-heading", theme) }, "Scan to connect with our mobile app"), props.onCancel && (0, preact_1.h)("button", {
			type: "button",
			className: "-cbwsdk-cancel-button",
			onClick: props.onCancel
		}, (0, preact_1.h)(CloseIcon_1.CloseIcon, { fill: theme === "light" ? "#0A0B0D" : "#FFFFFF" }))), (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-layout" }, (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-column-left" }, (0, preact_1.h)(ConnectItem, {
			title: wallet.title,
			description: wallet.description,
			theme
		})), (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-column-right" }, (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-qr-wrapper" }, (0, preact_1.h)(QRCode_1.QRCode, {
			content: qrUrl,
			width: 200,
			height: 200,
			fgColor: "#000",
			...
			type: "hidden",
			value: qrUrl
		})), (0, preact_1.h)(WalletSteps, { theme }), !props.isConnected && (0, preact_1.h)("div", {
	...
	function ConnectItem({ title, description, theme }) {
		return (0, preact_1.h)("div", { className: (0, clsx_1.default)("-cbwsdk-connect-item", theme) }, (0, preact_1.h)("div", null, (0, preact_1.h)(CoinbaseWalletRound_1.CoinbaseWalletRound, null)), (0, preact_1.h)("div", { className: "-cbwsdk-connect-item-copy-wrapper" }, (0, preact_1.h)("h3", { className: "-cbwsdk-connect-item-title" }, title), (0, preact_1.h)("p", { className: "-cbwsdk-connect-item-description" }, description)));
	}
	function CoinbaseWalletSteps({ theme }) {
		return (0, preact_1.h)("ol", { className: "-cbwsdk-wallet-steps" }, (0, preact_1.h)("li", { className: (0, clsx_1.default)("-cbwsdk-wallet-steps-item", theme) }, (0, preact_1.h)("div", { className: "-cbwsdk-wallet-steps-item-wrapper" }, "Open Coinbase Wallet app")), (0, preact_1.h)("li", { className: (0, clsx_1.default)("-cbwsdk-wallet-steps-item", theme) }, (0, preact_1.h)("div", { className: "-cbwsdk-wallet-steps-item-wrapper" }, (0, preact_1.h)("span", null, "Tap ", (0, preact_1.h)("strong", null, "Scan"), " "), (0, preact_1.h)("span", { className: (0, clsx_1.default)("-cbwsdk-wallet-steps-pad-left", "-cbwsdk-wallet-steps-icon", theme) }, (0, preact_1.h)(QRCodeIcon_1.QRCodeIcon, { fill: makeIconColor(theme) })))));
	}
	exports.CoinbaseWalletSteps = CoinbaseWalletSteps;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/ArrowLeftIcon.js
var require_ArrowLeftIcon = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function ArrowLeftIcon(props) {
		return (0, preact_1.h)("svg", Object.assign({
			...
			viewBox: "0 0 16 16",
			xmlns: "http://www.w3.org/2000/svg"
		}, props), (0, preact_1.h)("path", { d: "M8.60675 0.155884L7.37816 1.28209L12.7723 7.16662H0V8.83328H12.6548L6.82149 14.6666L8 15.8451L15.8201 8.02501L8.60675 0.155884Z" }));
	}
	exports.ArrowLeftIcon = ArrowLeftIcon;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/LaptopIcon.js
var require_LaptopIcon = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function LaptopIcon(props) {
		return (0, preact_1.h)("svg", Object.assign({
			...
			viewBox: "0 0 14 14",
			xmlns: "http://www.w3.org/2000/svg"
		}, props), (0, preact_1.h)("path", { d: "M1.8001 2.2002H12.2001V9.40019H1.8001V2.2002ZM3.4001 3.8002V7.80019H10.6001V3.8002H3.4001Z" }), (0, preact_1.h)("path", { d: "M13.4001 10.2002H0.600098C0.600098 11.0838 1.31644 11.8002 2.2001 11.8002H11.8001C12.6838 11.8002 13.4001 11.0838 13.4001 10.2002Z" }));
	}
	exports.LaptopIcon = LaptopIcon;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/icons/SafeIcon.js
var require_SafeIcon = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/TryExtensionContent/TryExtensionContent-css.js
var require_TryExtensionContent_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/TryExtensionContent/TryExtensionContent.js
var require_TryExtensionContent = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/ConnectDialog/ConnectDialog.js
var require_ConnectDialog = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var ConnectDialog = (props) => {
		...
		}) : null, (0, preact_1.h)(TryExtensionContent_1.TryExtensionContent, { theme }))));
	};
	exports.ConnectDialog = ConnectDialog;
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/LinkFlow/LinkFlow.js
var require_LinkFlow = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Snackbar/Snackbar-css.js
var require_Snackbar_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Snackbar/Snackbar.js
var require_Snackbar$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Snackbar = class {
		...
		render() {
			if (!this.root) return;
			(0, preact_1.render)((0, preact_1.h)("div", null, (0, preact_1.h)(exports.SnackbarContainer, { darkMode: this.darkMode }, Array.from(this.items.entries()).map(([key, itemProps]) => (0, preact_1.h)(exports.SnackbarInstance, Object.assign({}, itemProps, { key }))))), this.root);
		}
	};
	exports.Snackbar = Snackbar;
	var SnackbarContainer = (props) => (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-snackbar-container") }, (0, preact_1.h)("style", null, Snackbar_css_1.default), (0, preact_1.h)("div", { class: "-cbwsdk-snackbar" }, props.children));
	...
	var SnackbarInstance = ({ autoExpand, message, menuItems }) => {
		...
		return (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-snackbar-instance", hidden && "-cbwsdk-snackbar-instance-hidden", expanded && "-cbwsdk-snackbar-instance-expanded") }, (0, preact_1.h)("div", {
			class: "-cbwsdk-snackbar-instance-header",
			onClick: toggleExpanded
		}, (0, preact_1.h)("img", {
			src: cblogo,
			class: "-cbwsdk-snackbar-instance-header-cblogo"
		}), " ", (0, preact_1.h)("div", { class: "-cbwsdk-snackbar-instance-header-message" }, message), (0, preact_1.h)("div", { class: "-gear-container" }, !expanded && (0, preact_1.h)("svg", {
			width: "24",
			height: "24",
			viewBox: "0 0 24 24",
			fill: "none",
			...
			class: "-gear-icon",
			title: "Expand"
		}))), menuItems && menuItems.length > 0 && (0, preact_1.h)("div", { class: "-cbwsdk-snackbar-instance-menu" }, menuItems.map((action, i) => (0, preact_1.h)("div", {
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/WalletLinkRelayUI.js
var require_WalletLinkRelayUI = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.WalletLinkRelayUI = void 0;
	var cssReset_1 = require_cssReset();
	var LinkFlow_1 = require_LinkFlow();
	var Snackbar_1 = require_Snackbar$1();
	var WalletLinkRelayUI = class {
		constructor(options) {
			this.standalone = null;
			this.attached = false;
			this.snackbar = new Snackbar_1.Snackbar({ darkMode: options.darkMode });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/WalletLinkRelay.js
var require_WalletLinkRelay = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var WalletLinkRelay = class WalletLinkRelay extends RelayAbstract_1.RelayAbstract {
		constructor(options) {
			var _a;
			super();
			...
			this.linkedUpdated = (linked) => {
				...
				if (linked) this.session.linked = linked;
				...
				if (cachedAddresses) {
					...
					if (addresses[0] !== "" && !linked && this.session.linked && !wasConnectedViaStandalone) {
						...
						(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.UNLINKED_ERROR_STATE, { sessionIdHash });
					}
				}
			};
		...
		resetAndReload() {
			Promise.race([this.connection.setSessionMetadata("__destroyed", "1"), new Promise((resolve) => setTimeout(() => resolve(null), 1e3))]).then(() => {
				var _a, _b;
				const isStandalone = this.ui.isStandalone();
				(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.SESSION_STATE_CHANGE, {
				...
				*/
				...
				if ((storedSession === null || storedSession === void 0 ? void 0 : storedSession.id) === this._session.id) this.storage.clear();
				else if (storedSession) (_b = this.diagnostic) === null || _b === void 0 || _b.log(DiagnosticLogger_1.EVENTS.SKIPPED_CLEARING_SESSION, {
					sessionIdHash: this.getSessionIdHash(),
				...
				if (this.accountsCallback) this.accountsCallback([], true);
				const { session, ui, connection } = this.subscribe();
				this._session = session;
				this.connection = connection;
				this.ui = ui;
				...
				var _a;
				(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.FAILURE, {
					method: "relay::resetAndReload",
		...
		sendRequest(request) {
			...
			return {
				promise: new Promise((resolve, reject) => {
					if (!this.ui.isStandalone()) hideSnackbarItem = this.ui.showConnecting({
					...
					this.relayEventManager.callbacks.set(id, (response) => {
						hideSnackbarItem === null || hideSnackbarItem === void 0 || hideSnackbarItem();
						if ((0, Web3Response_1.isErrorResponse)(response)) return reject(new Error(response.errorMessage));
						resolve(response);
					});
					if (this.ui.isStandalone()) this.sendRequestStandalone(id, request);
					else this.publishWeb3RequestEvent(id, request);
				}),
				cancel
			};
		}
		...
		setDappDefaultChainCallback(chainId) {
			...
			if (this.ui instanceof WalletLinkRelayUI_1.WalletLinkRelayUI) this.ui.setChainId(chainId);
		}
		publishWeb3RequestEvent(id, request) {
			...
			const storedSession = Session_1.Session.load(this.storage);
			(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.WEB3_REQUEST, {
				eventId: message.id,
			...
			this.publishEvent("Web3Request", message, true).then((_) => {
				var _a;
				(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.WEB3_REQUEST_PUBLISHED, {
					eventId: message.id,
					method: `relay::${request.method}`,
					sessionIdHash: this.getSessionIdHash(),
					storedSessionIdHash: storedSession ? Session_1.Session.hash(storedSession.id) : "",
		...
		handleWeb3ResponseMessage(message) {
			...
			(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.WEB3_RESPONSE, {
				eventId: message.id,
			...
			return {
				promise: new Promise((resolve, reject) => {
					...
					if (this.ui.inlineAccountsResponse()) {
						...
						this.ui.requestEthereumAccounts({ onCancel: () => cancel(err) });
					}
					WalletLinkRelay.accountRequestCallbackIds.add(id);
					if (!this.ui.inlineAccountsResponse() && !this.ui.isStandalone()) this.publishWeb3RequestEvent(id, request);
				}),
				cancel
			};
		}
		...
		watchAsset(type, address, symbol, decimals, image, chainId) {
			...
			if (!this.ui.inlineWatchAsset()) hideSnackbarItem = this.ui.showConnecting({
				isUnlinkedErrorState: this.isUnlinkedErrorState,
				onCancel: cancel,
				onResetConnection: this.resetAndReload
			});
			return {
				...
				promise: new Promise((resolve, reject) => {
					...
					if (this.ui.inlineWatchAsset()) this.ui.watchAsset({
						onApprove: approve,
						onCancel: _cancel,
						type,
						address,
					...
					if (!this.ui.inlineWatchAsset() && !this.ui.isStandalone()) this.publishWeb3RequestEvent(id, request);
				})
			};
		}
		addEthereumChain(chainId, rpcUrls, iconUrls, blockExplorerUrls, chainName, nativeCurrency) {
			...
			if (!this.ui.inlineAddEthereumChain(chainId)) hideSnackbarItem = this.ui.showConnecting({
				isUnlinkedErrorState: this.isUnlinkedErrorState,
				onCancel: cancel,
				onResetConnection: this.resetAndReload
			});
			return {
				promise: new Promise((resolve, reject) => {
					...
					if (this.ui.inlineAddEthereumChain(chainId)) this.ui.addEthereumChain({
						onCancel: _cancel,
						onApprove: approve,
					...
					if (!this.ui.inlineAddEthereumChain(chainId) && !this.ui.isStandalone()) this.publishWeb3RequestEvent(id, request);
				}),
				cancel
			};
		}
		switchEthereumChain(chainId, address) {
			...
			return {
				promise: new Promise((resolve, reject) => {
					this.relayEventManager.callbacks.set(id, (response) => {
						if ((0, Web3Response_1.isErrorResponse)(response) && response.errorCode) return reject(error_1.standardErrors.provider.custom({
							code: response.errorCode,
							message: `Unrecognized chain ID. Try adding the chain using addEthereumChain first.`
						}));
						else if ((0, Web3Response_1.isErrorResponse)(response)) return reject(new Error(response.errorMessage));
						resolve(response);
					});
					const _cancel = (error) => {
						var _a;
					...
					if (!this.ui.inlineSwitchEthereumChain() && !this.ui.isStandalone()) this.publishWeb3RequestEvent(id, request);
				}),
				cancel
			};
		}
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Snackbar/index.js
var require_Snackbar = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(require_Snackbar$1(), exports);
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/RedirectDialog/RedirectDialog-css.js
var require_RedirectDialog_css = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/walletlink/ui/components/RedirectDialog/RedirectDialog.js
var require_RedirectDialog = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var RedirectDialogContent = ({ title, buttonText, darkMode, onButtonClick, onDismiss }) => {
		const theme = darkMode ? "dark" : "light";
		return (0, preact_1.h)(Snackbar_1.SnackbarContainer, { darkMode }, (0, preact_1.h)("div", { class: "-cbwsdk-redirect-dialog" }, (0, preact_1.h)("style", null, RedirectDialog_css_1.default), (0, preact_1.h)("div", {
			class: "-cbwsdk-redirect-dialog-backdrop",
			onClick: onDismiss
		}), (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-redirect-dialog-box", theme) }, (0, preact_1.h)("p", null, title), (0, preact_1.h)("button", { onClick: onButtonClick }, buttonText))));
	};
}));
//#endregion
//#region node_modules/cbw-sdk/dist/relay/mobile/MobileRelayUI.js
var require_MobileRelayUI = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/mobile/MobileRelay.js
var require_MobileRelay = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var MobileRelay = class extends WalletLinkRelay_1.WalletLinkRelay {
		...
		requestEthereumAccounts() {
			if (this._enableMobileWalletLink) return super.requestEthereumAccounts();
			return {
				promise: new Promise(() => {
		...
		publishWeb3RequestEvent(id, request) {
			...
			if (navigatedToCBW) window.addEventListener("blur", () => {
...
//#endregion
//#region node_modules/readable-stream/lib/internal/streams/stream-browser.js
...
var require_buffer_list = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var inspect = require_browser_external_util().inspect;
...
//#endregion
//#region node_modules/readable-stream/errors-browser.js
...
//#endregion
//#region node_modules/util-deprecate/browser.js
...
//#endregion
//#region node_modules/readable-stream/lib/internal/streams/from-browser.js
...
var require__stream_readable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var debugUtil = require_browser_external_util();
	var debug;
...
//#endregion
//#region node_modules/readable-stream/readable-browser.js
...
//#endregion
//#region node_modules/keccak/lib/api/keccak.js
var require_keccak$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/keccak/lib/api/shake.js
var require_shake = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform } = require_readable_browser();
...
//#endregion
//#region node_modules/keccak/lib/api/index.js
var require_api = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var createKeccak = require_keccak$1();
	var createShake = require_shake();
	module.exports = function(KeccakState) {
		const Keccak = createKeccak(KeccakState);
		const Shake = createShake(KeccakState);
		return function(algorithm, options) {
			switch (typeof algorithm === "string" ? algorithm.toLowerCase() : algorithm) {
				case "keccak224": return new Keccak(1152, 448, null, 224, options);
				case "keccak256": return new Keccak(1088, 512, null, 256, options);
				case "keccak384": return new Keccak(832, 768, null, 384, options);
				case "keccak512": return new Keccak(576, 1024, null, 512, options);
				case "sha3-224": return new Keccak(1152, 448, 6, 224, options);
				case "sha3-256": return new Keccak(1088, 512, 6, 256, options);
				case "sha3-384": return new Keccak(832, 768, 6, 384, options);
				case "sha3-512": return new Keccak(576, 1024, 6, 512, options);
				case "shake128": return new Shake(1344, 256, 31, options);
				case "shake256": return new Shake(1088, 512, 31, options);
...
//#endregion
//#region node_modules/keccak/lib/keccak-state-unroll.js
var require_keccak_state_unroll = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/keccak/lib/keccak.js
var require_keccak = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/keccak/js.js
var require_js = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_api()(require_keccak());
}));
//#endregion
//#region node_modules/cbw-sdk/dist/vendor-js/eth-eip712-util/util.js
...
//#endregion
//#region node_modules/cbw-sdk/dist/vendor-js/eth-eip712-util/abi.js
var require_abi = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function parseNumber(arg) {
		var type = typeof arg;
		if (type === "string") if (util.isHexString(arg)) return new BN(util.stripHexPrefix(arg), 16);
		else return new BN(arg, 10);
		else if (type === "number") return new BN(arg);
		else if (arg.toArray) return arg;
...
//#endregion
//#region node_modules/cbw-sdk/dist/vendor-js/eth-eip712-util/index.js
var require_eth_eip712_util = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var util = require_util();
	var abi = require_abi();
...
//#endregion
//#region node_modules/cbw-sdk/dist/provider/FilterPolyfill.js
var require_FilterPolyfill = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var FilterPolyfill = class {
		...
		getFilterChanges(filterId) {
			const id = (0, util_1.intNumberFromHexString)(filterId);
			if (this.timeouts.has(id)) this.setFilterTimeout(id);
		...
		sendAsyncPromise(request) {
			return new Promise((resolve, reject) => {
				this.provider.sendAsync(request, (err, response) => {
					...
					if (Array.isArray(response) || response == null) return reject(/* @__PURE__ */ new Error(`unexpected response received: ${JSON.stringify(response)}`));
					resolve(response);
				});
			});
		}
		...
		async getLogFilterChanges(id) {
			...
			if (cursorPosition > Number(filter.toBlock)) return emptyResult();
		...
		async getBlockFilterChanges(id) {
			...
			const blocks = (await Promise.all((0, util_1.range)(cursorPosition, currentBlockHeight + 1).map((i) => this.getBlockHashByNumber((0, type_1.IntNumber)(i))))).filter((hash) => !!hash);
		...
		async getCurrentBlockHeight() {
			...
			if (!this.currentBlockHeight) return new Promise((resolve) => this.resolvers.push(resolve));
	...
	function intBlockHeightFromHexBlockHeight(value) {
		if (value === void 0 || value === "latest" || value === "pending") return "latest";
		else if (value === "earliest") return (0, type_1.IntNumber)(0);
	...
	function filterNotFoundError() {
		return Object.assign(Object.assign({}, JSONRPC_TEMPLATE), { error: {
			code: -32e3,
...
//#endregion
//#region node_modules/json-rpc-random-id/index.js
var require_json_rpc_random_id = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/pify/index.js
...
//#endregion
//#region node_modules/@metamask/safe-event-emitter/dist/cjs/index.js
...
//#endregion
//#region node_modules/eth-block-tracker/dist/BaseBlockTracker.js
var require_BaseBlockTracker = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var BaseBlockTracker = class extends safe_event_emitter_1.default {
		...
		async getLatestBlock() {
			...
			return await new Promise((resolve) => this.once("latest", resolve));
		}
		...
		_onNewListener(eventName) {
			if (blockTrackerEvents.includes(eventName)) this._maybeStart();
		}
		_onRemoveListener() {
		...
		_newPotentialLatest(newBlock) {
			if (!this._shouldUseNewBlock(newBlock)) return;
...
//#endregion
//#region node_modules/eth-block-tracker/node_modules/superstruct/dist/index.mjs
...
var require_bytes = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function hexToBytes(value) {
		var _a;
		if (((_a = value === null || value === void 0 ? void 0 : value.toLowerCase) === null || _a === void 0 ? void 0 : _a.call(value)) === "0x") return new Uint8Array();
...
var require_coercers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function createBytes(value) {
		if (typeof value === "string" && value.toLowerCase() === "0x") return new Uint8Array();
		try {
...
var require_logging = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var globalLogger = (0, __importDefault(require_browser$1()).default)("metamask");
	/**
...
//#endregion
//#region node_modules/eth-block-tracker/dist/logging-utils.js
var require_logging_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.createModuleLogger = exports.projectLogger = void 0;
	var utils_1 = require_dist$4();
...
//#endregion
//#region node_modules/eth-block-tracker/dist/PollingBlockTracker.js
var require_PollingBlockTracker = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var pify_1 = __importDefault(require_pify$1());
	...
	var PollingBlockTracker = class extends BaseBlockTracker_1.BaseBlockTracker {
		...
		async _synchronize() {
			...
			while (this._isRunning) try {
				...
				const newErr = /* @__PURE__ */ new Error(`PollingBlockTracker - encountered an error while attempting to update latest block:\n${(_a = err.stack) !== null && _a !== void 0 ? _a : err}`);
				try {
	...
	*/
	function timeout(duration, unref) {
		return new Promise((resolve) => {
			...
			if (timeoutRef.unref && unref) timeoutRef.unref();
		});
	}
}));
//#endregion
//#region node_modules/eth-block-tracker/dist/SubscribeBlockTracker.js
var require_SubscribeBlockTracker = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var SubscribeBlockTracker = class extends BaseBlockTracker_1.BaseBlockTracker {
		...
		_handleSubData(_, response) {
			var _a;
			if (response.method === "eth_subscription" && ((_a = response.params) === null || _a === void 0 ? void 0 : _a.subscription) === this._subscriptionId) this._newPotentialLatest(response.params.result.number);
		}
	};
	exports.SubscribeBlockTracker = SubscribeBlockTracker;
}));
//#endregion
//#region node_modules/eth-block-tracker/dist/index.js
...
//#endregion
//#region node_modules/json-rpc-engine/dist/getUniqueId.js
var require_getUniqueId = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/json-rpc-engine/dist/idRemapMiddleware.js
var require_idRemapMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/json-rpc-engine/dist/createAsyncMiddleware.js
var require_createAsyncMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/json-rpc-engine/dist/createScaffoldMiddleware.js
var require_createScaffoldMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_error_constants = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/json-rpc-engine/dist/JsonRpcEngine.js
var require_JsonRpcEngine = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var eth_rpc_errors_1 = require_dist$2();
	exports.JsonRpcEngine = class JsonRpcEngine extends safe_event_emitter_1.default {
		constructor() {
			super();
			this._middleware = [];
		}
...
//#endregion
//#region node_modules/json-rpc-engine/dist/mergeMiddleware.js
var require_mergeMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/json-rpc-engine/dist/index.js
...
//#endregion
//#region node_modules/eth-query/index.js
var require_eth_query = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	EthQuery.prototype.sendAsync = function(opts, cb) {
		this.currentProvider.sendAsync(createPayload(opts), function(err, response) {
			if (!err && response.error) err = /* @__PURE__ */ new Error("EthQuery - RPC Error - " + response.error.message);
...
//#endregion
//#region node_modules/eth-json-rpc-filters/node_modules/pify/index.js
var require_pify = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = (input, options) => {
		...
		const filter = (target, key) => {
			...
			const shouldFilter = (options.include ? options.include.some(match) : !options.exclude.some(match)) && writableOrConfigurableOwn;
...
//#endregion
//#region node_modules/eth-json-rpc-filters/base-filter.js
var require_base_filter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/eth-json-rpc-filters/base-filter-history.js
var require_base_filter_history = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/eth-json-rpc-filters/hexUtils.js
var require_hexUtils = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		minBlockRef,
		maxBlockRef,
		sortBlockRefs,
	...
	function incrementHexInt(hexString) {
		if (hexString === void 0 || hexString === null) return hexString;
		return intToHex(hexToInt(hexString) + 1);
	}
...
//#endregion
//#region node_modules/eth-json-rpc-filters/log-filter.js
var require_log_filter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var LogFilter = class extends BaseFilterWithHistory {
		constructor({ provider, params }) {
			...
			if (this.params.address) {
				if (!Array.isArray(this.params.address)) this.params.address = [this.params.address];
		...
		async update({ oldBlock, newBlock }) {
			...
			const matchingLogs = (await this._fetchLogs(params)).filter((log) => this.matchLog(log));
			this.addResults(matchingLogs);
		}
		async _fetchLogs(params) {
			return await pify((cb) => this.ethQuery.getLogs(params, cb))();
		}
		matchLog(log) {
			...
			return this.params.topics.every((topicPattern, index) => {
				let logTopic = log.topics[index];
				if (!logTopic) return false;
				logTopic = logTopic.toLowerCase();
				let subtopicsToMatch = Array.isArray(topicPattern) ? topicPattern : [topicPattern];
				if (subtopicsToMatch.includes(null)) return true;
				subtopicsToMatch = subtopicsToMatch.map((topic) => topic.toLowerCase());
				return subtopicsToMatch.includes(logTopic);
			});
		}
	};
...
//#endregion
//#region node_modules/eth-json-rpc-filters/getBlocksForRange.js
var require_getBlocksForRange = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = getBlocksForRange;
	async function getBlocksForRange({ provider, fromBlock, toBlock }) {
		if (!fromBlock) fromBlock = toBlock;
		const fromBlockNumber = hexToInt(fromBlock);
		const blockCountToQuery = hexToInt(toBlock) - fromBlockNumber + 1;
	...
	function sendAsync(provider, request) {
		return new Promise((resolve, reject) => {
			provider.sendAsync(request, (error, response) => {
				...
				else reject(/* @__PURE__ */ new Error("Result was empty"));
			});
		});
	}
...
//#endregion
//#region node_modules/eth-json-rpc-filters/block-filter.js
var require_block_filter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var BaseFilter = require_base_filter();
	...
	var BlockFilter = class extends BaseFilter {
		...
		async update({ oldBlock, newBlock }) {
			...
			const blockHashes = (await getBlocksForRange({
...
//#endregion
//#region node_modules/eth-json-rpc-filters/tx-filter.js
var require_tx_filter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var BaseFilter = require_base_filter();
	var getBlocksForRange = require_getBlocksForRange();
	var { incrementHexInt } = require_hexUtils();
...
//#endregion
//#region node_modules/eth-json-rpc-filters/index.js
var require_eth_json_rpc_filters = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Mutex = require_lib().Mutex;
	var { createAsyncMiddleware, createScaffoldMiddleware } = require_dist$1();
	...
	function createEthFilterMiddleware({ blockTracker, provider }) {
		...
		async function getFilterChanges(filterIndexHex) {
			...
			if (!filter) throw new Error(`No filter for index "${filterIndex}"`);
		...
		async function getFilterLogs(filterIndexHex) {
			...
			if (!filter) throw new Error(`No filter for index "${filterIndex}"`);
			let results = [];
			if (filter.type === "log") results = filter.getAllResults();
			return results;
		}
		async function uninstallFilterHandler(filterIndexHex) {
			...
			if (result) await uninstallFilter(filterIndex);
			return result;
		}
	...
	function toFilterCreationMiddleware(createFilterFn) {
		return toAsyncRpcMiddleware(async (...args) => {
			return intToHex((await createFilterFn(...args)).id);
		});
	}
	function toAsyncRpcMiddleware(asyncFn) {
		return createAsyncMiddleware(async (req, res) => {
			res.result = await asyncFn.apply(null, req.params);
		});
	}
...
//#endregion
//#region node_modules/eth-json-rpc-filters/subscriptionManager.js
var require_subscriptionManager = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var SafeEventEmitter = require_cjs().default;
	var { createAsyncMiddleware, createScaffoldMiddleware } = require_dist$1();
		...
		async function subscribe(req, res) {
			...
			switch (subscriptionType) {
				...
				case "logs":
					...
					break;
				default: throw new Error(`SubscriptionManager - unsupported subscription type "${subscriptionType}"`);
			}
			...
			function createSubNewHeads({ subId }) {
				const sub = {
					...
					update: async ({ oldBlock, newBlock }) => {
						const toBlock = newBlock;
						(await getBlocksForRange({
							provider,
							fromBlock: incrementHexInt(oldBlock),
							toBlock
						})).map(normalizeBlock).filter((block) => block !== null).forEach((value) => {
...
//#endregion
//#region node_modules/cbw-sdk/dist/provider/SubscriptionManager.js
var require_SubscriptionManager = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.SubscriptionManager = void 0;
	var eth_block_tracker_1 = require_dist$3();
	var createSubscriptionManager = require_subscriptionManager();
	var noop = () => {};
	var SubscriptionManager = class {
		constructor(provider) {
			const { events, middleware } = createSubscriptionManager({
				blockTracker: new eth_block_tracker_1.PollingBlockTracker({
					provider,
...
//#endregion
//#region node_modules/cbw-sdk/dist/provider/CoinbaseWalletProvider.js
var require_CoinbaseWalletProvider = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var CoinbaseWalletProvider = class extends eventemitter3_1.EventEmitter {
		constructor(options) {
			...
			if (this._isAuthorized()) this.initializeRelay();
		...
		*/
		...
		updateProviderInfo(jsonRpcUrl, chainId) {
			...
			if ((0, util_1.ensureIntNumber)(chainId) !== originalChainId || !this.hasMadeFirstChainChangedEmission) {
				this.emit("chainChanged", this.getChainId());
				this.hasMadeFirstChainChangedEmission = true;
			}
		}
		async watchAsset(type, address, symbol, decimals, image, chainId) {
			const result = await (await this.initializeRelay()).watchAsset(type, address, symbol, decimals, image, chainId === null || chainId === void 0 ? void 0 : chainId.toString()).promise;
			if ((0, Web3Response_1.isErrorResponse)(result)) return false;
			return !!result.result;
		}
		async addEthereumChain(chainId, rpcUrls, blockExplorerUrls, chainName, iconUrls, nativeCurrency) {
			var _a, _b;
			if ((0, util_1.ensureIntNumber)(chainId) === this.getChainId()) return false;
			const relay = await this.initializeRelay();
			const isWhitelistedNetworkOrStandalone = relay.inlineAddEthereumChain(chainId.toString());
			if (!this._isAuthorized() && !isWhitelistedNetworkOrStandalone) await relay.requestEthereumAccounts().promise;
			const res = await relay.addEthereumChain(chainId.toString(), rpcUrls, iconUrls, blockExplorerUrls, chainName, nativeCurrency).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) return false;
			if (((_a = res.result) === null || _a === void 0 ? void 0 : _a.isApproved) === true) this.updateProviderInfo(rpcUrls[0], chainId);
			return ((_b = res.result) === null || _b === void 0 ? void 0 : _b.isApproved) === true;
		}
		async switchEthereumChain(chainId) {
			const res = await (await this.initializeRelay()).switchEthereumChain(chainId.toString(10), this.selectedAddress || void 0).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) {
				if (!res.errorCode) return;
				if (res.errorCode === error_1.standardErrorCodes.provider.unsupportedChain) throw error_1.standardErrors.provider.unsupportedChain();
				else throw error_1.standardErrors.provider.custom({
		...
		async enable() {
			var _a;
			(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.ETH_ACCOUNTS_STATE, {
				method: "provider::enable",
				addresses_length: this._addresses.length,
				sessionIdHash: this._relay ? Session_1.Session.hash(this._relay.session.id) : void 0
			});
			if (this._isAuthorized()) return [...this._addresses];
		...
		_send(requestOrMethod, callbackOrParams) {
			if (typeof requestOrMethod === "string") {
				const request = {
					...
					params: Array.isArray(callbackOrParams) ? callbackOrParams : callbackOrParams !== void 0 ? [callbackOrParams] : []
				};
			...
			if (Array.isArray(requestOrMethod)) return requestOrMethod.map((r) => this._sendRequest(r));
		...
		async _request(args) {
			if (!args || typeof args !== "object" || Array.isArray(args)) throw error_1.standardErrors.rpc.invalidRequest({
				message: "Expected a single, non-array, object argument.",
				data: args
			});
			const { method, params } = args;
			if (typeof method !== "string" || method.length === 0) throw error_1.standardErrors.rpc.invalidRequest({
				message: "'args.method' must be a non-empty string.",
				data: args
			});
			if (params !== void 0 && !Array.isArray(params) && (typeof params !== "object" || params === null)) throw error_1.standardErrors.rpc.invalidRequest({
		...
		async scanQRCode(match) {
			const res = await (await this.initializeRelay()).scanQRCode((0, util_1.ensureRegExpString)(match)).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) throw (0, error_1.serializeError)(res.errorMessage, "scanQRCode");
			else if (typeof res.result !== "string") throw (0, error_1.serializeError)("result was not a string", "scanQRCode");
			return res.result;
		}
		async genericRequest(data, action) {
			const res = await (await this.initializeRelay()).genericRequest(data, action).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) throw (0, error_1.serializeError)(res.errorMessage, "generic");
			else if (typeof res.result !== "string") throw (0, error_1.serializeError)("result was not a string", "generic");
			return res.result;
		}
		/**
		* @beta
		...
		*/
		async connectAndSignIn(params) {
			...
			try {
				const relay = await this.initializeRelay();
				if (!(relay instanceof MobileRelay_1.MobileRelay)) throw new Error("connectAndSignIn is only supported on mobile");
				res = await relay.connectAndSignIn(params).promise;
				if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
			} catch (err) {
				if (typeof err.message === "string" && err.message.match(/(denied|rejected)/i)) throw error_1.standardErrors.provider.userRejectedRequest("User denied account authorization");
				throw err;
			}
			if (!res.result) throw new Error("accounts received is empty");
			const { accounts } = res.result;
			this._setAddresses(accounts);
			if (!this.isCoinbaseBrowser) await this.switchEthereumChain(this.getChainId());
			return res.result;
		}
		async selectProvider(providerOptions) {
			const res = await (await this.initializeRelay()).selectProvider(providerOptions).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) throw (0, error_1.serializeError)(res.errorMessage, "selectProvider");
			else if (typeof res.result !== "string") throw (0, error_1.serializeError)("result was not a string", "selectProvider");
			return res.result;
		}
		...
		_sendRequest(request) {
			...
			if (response.result === void 0) throw new Error(`Coinbase Wallet does not support calling ${method} synchronously without a callback. Please provide a callback parameter to call ${method} asynchronously.`);
			return response;
		}
		...
		_sendRequestAsync(request) {
			return new Promise((resolve, reject) => {
				try {
					...
					if (syncResult !== void 0) return resolve({
						jsonrpc: "2.0",
						id: request.id,
						result: syncResult
					});
		...
		_handleSynchronousMethods(request) {
			...
			switch (method) {
				case "eth_accounts": return this._eth_accounts();
				case "eth_coinbase": return this._eth_coinbase();
				case "eth_uninstallFilter": return this._eth_uninstallFilter(params);
				case "net_version": return this._net_version();
				case "eth_chainId": return this._eth_chainId();
				default: return;
			}
		}
		async _handleAsynchronousMethods(request) {
			...
			switch (method) {
				...
				case "eth_sign": return this._eth_sign(params);
				case "eth_ecRecover": return this._eth_ecRecover(params);
				case "personal_sign": return this._personal_sign(params);
				case "personal_ecRecover": return this._personal_ecRecover(params);
				...
				case "eth_signTypedData_v1": return this._eth_signTypedData_v1(params);
				case "eth_signTypedData_v2": return this._throwUnsupportedMethodError();
				case "eth_signTypedData_v3": return this._eth_signTypedData_v3(params);
				case "eth_signTypedData_v4":
				case "eth_signTypedData": return this._eth_signTypedData_v4(params);
				case "cbWallet_arbitrary": return this._cbwallet_arbitrary(params);
				case "wallet_addEthereumChain": return this._wallet_addEthereumChain(params);
				case "wallet_switchEthereumChain": return this._wallet_switchEthereumChain(params);
				case "wallet_watchAsset": return this._wallet_watchAsset(params);
			}
			return (await this.initializeRelay()).makeEthereumJSONRPCRequest(request, this.jsonRpcUrl).catch((err) => {
				var _a;
				if (err.code === error_1.standardErrorCodes.rpc.methodNotFound || err.code === error_1.standardErrorCodes.rpc.methodNotSupported) (_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.METHOD_NOT_IMPLEMENTED, {
					method: request.method,
					sessionIdHash: this._relay ? Session_1.Session.hash(this._relay.session.id) : void 0
				});
				throw err;
		...
		_handleAsynchronousFilterMethods(request) {
			...
			const params = request.params || [];
			switch (method) {
				case "eth_newFilter": return this._eth_newFilter(params);
				case "eth_newBlockFilter": return this._eth_newBlockFilter();
				case "eth_newPendingTransactionFilter": return this._eth_newPendingTransactionFilter();
				case "eth_getFilterChanges": return this._eth_getFilterChanges(params);
				case "eth_getFilterLogs": return this._eth_getFilterLogs(params);
			}
		}
		_handleSubscriptionMethods(request) {
			switch (request.method) {
				case "eth_subscribe":
				case "eth_unsubscribe": return this._subscriptionManager.handleRequest(request);
			}
		}
		_isKnownAddress(addressString) {
			try {
				const addressStr = (0, util_1.ensureAddressString)(addressString);
				return this._addresses.map((address) => (0, util_1.ensureAddressString)(address)).includes(addressStr);
			} catch (_a) {}
			return false;
		}
		_ensureKnownAddress(addressString) {
			...
			if (!this._isKnownAddress(addressString)) {
				(_a = this.diagnostic) === null || _a === void 0 || _a.log(DiagnosticLogger_1.EVENTS.UNKNOWN_ADDRESS_ENCOUNTERED);
		...
		_prepareTransactionParams(tx) {
			...
			return {
				fromAddress,
				toAddress: tx.to ? (0, util_1.ensureAddressString)(tx.to) : null,
				weiValue: tx.value != null ? (0, util_1.ensureBN)(tx.value) : new bn_js_1.default(0),
				data: tx.data ? (0, util_1.ensureBuffer)(tx.data) : Buffer.alloc(0),
				nonce: tx.nonce != null ? (0, util_1.ensureIntNumber)(tx.nonce) : null,
				gasPriceInWei: tx.gasPrice != null ? (0, util_1.ensureBN)(tx.gasPrice) : null,
				maxFeePerGas: tx.maxFeePerGas != null ? (0, util_1.ensureBN)(tx.maxFeePerGas) : null,
				maxPriorityFeePerGas: tx.maxPriorityFeePerGas != null ? (0, util_1.ensureBN)(tx.maxPriorityFeePerGas) : null,
				gasLimit: tx.gas != null ? (0, util_1.ensureBN)(tx.gas) : null,
				chainId: tx.chainId ? (0, util_1.ensureIntNumber)(tx.chainId) : this.getChainId()
			};
		}
		_isAuthorized() {
		...
		_requireAuthorization() {
			if (!this._isAuthorized()) throw error_1.standardErrors.provider.unauthorized({});
		}
		...
		async _signEthereumMessage(message, address, addPrefix, typedDataJson) {
			...
			try {
				const res = await (await this.initializeRelay()).signEthereumMessage(message, address, addPrefix, typedDataJson).promise;
				if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
				return {
					jsonrpc: "2.0",
					id: 0,
				...
				if (typeof err.message === "string" && err.message.match(/(denied|rejected)/i)) throw error_1.standardErrors.provider.userRejectedRequest("User denied message signature");
				throw err;
			}
		}
		async _ethereumAddressFromSignedMessage(message, signature, addPrefix) {
			const res = await (await this.initializeRelay()).ethereumAddressFromSignedMessage(message, signature, addPrefix).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
			return {
				jsonrpc: "2.0",
				id: 0,
		...
		getChainId() {
			...
			if (!chainIdStr) return (0, util_1.ensureIntNumber)(this._chainIdFromOpts);
		...
		async _eth_requestAccounts() {
			...
			let res;
			try {
				res = await (await this.initializeRelay()).requestEthereumAccounts().promise;
				if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
			} catch (err) {
				if (typeof err.message === "string" && err.message.match(/(denied|rejected)/i)) throw error_1.standardErrors.provider.userRejectedRequest("User denied account authorization");
				throw err;
		...
		async _eth_signTransaction(params) {
			...
			try {
				const res = await (await this.initializeRelay()).signEthereumTransaction(tx).promise;
				if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
				return {
					jsonrpc: "2.0",
					id: 0,
				...
				if (typeof err.message === "string" && err.message.match(/(denied|rejected)/i)) throw error_1.standardErrors.provider.userRejectedRequest("User denied transaction signature");
				throw err;
			}
		}
		async _eth_sendRawTransaction(params) {
			const signedTransaction = (0, util_1.ensureBuffer)(params[0]);
			const res = await (await this.initializeRelay()).submitEthereumTransaction(signedTransaction, this.getChainId()).promise;
			if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
			return {
				jsonrpc: "2.0",
				id: 0,
		...
		async _eth_sendTransaction(params) {
			...
			const tx = this._prepareTransactionParams(params[0] || {});
			try {
				const res = await (await this.initializeRelay()).signAndSubmitEthereumTransaction(tx).promise;
				if ((0, Web3Response_1.isErrorResponse)(res)) throw new Error(res.errorMessage);
				return {
					jsonrpc: "2.0",
					id: 0,
		...
		async _cbwallet_arbitrary(params) {
			...
			if (typeof action !== "object" || action === null) throw new Error("parameter must be an object");
			return {
				jsonrpc: "2.0",
				id: 0,
				result: await this.genericRequest(action, data)
			};
		}
		async _wallet_addEthereumChain(params) {
			var _a, _b, _c, _d;
			const request = params[0];
			if (((_a = request.rpcUrls) === null || _a === void 0 ? void 0 : _a.length) === 0) return {
				jsonrpc: "2.0",
				id: 0,
				error: {
					code: 2,
			...
			if (!request.chainName || request.chainName.trim() === "") throw error_1.standardErrors.rpc.invalidParams("chainName is a required field");
			if (!request.nativeCurrency) throw error_1.standardErrors.rpc.invalidParams("nativeCurrency is a required field");
			const chainIdNumber = parseInt(request.chainId, 16);
			if (await this.addEthereumChain(chainIdNumber, (_b = request.rpcUrls) !== null && _b !== void 0 ? _b : [], (_c = request.blockExplorerUrls) !== null && _c !== void 0 ? _c : [], request.chainName, (_d = request.iconUrls) !== null && _d !== void 0 ? _d : [], request.nativeCurrency)) return {
				jsonrpc: "2.0",
				id: 0,
				result: null
			};
		...
		async _wallet_watchAsset(params) {
			...
			if (!request.type) throw error_1.standardErrors.rpc.invalidParams("Type is required");
			if ((request === null || request === void 0 ? void 0 : request.type) !== "ERC20") throw error_1.standardErrors.rpc.invalidParams(`Asset of type '${request.type}' is not supported`);
			if (!(request === null || request === void 0 ? void 0 : request.options)) throw error_1.standardErrors.rpc.invalidParams("Options are required");
			if (!(request === null || request === void 0 ? void 0 : request.options.address)) throw error_1.standardErrors.rpc.invalidParams("Address is required");
			const chainId = this.getChainId();
			const { address, symbol, image, decimals } = request.options;
			return {
				jsonrpc: "2.0",
				id: 0,
				result: await this.watchAsset(request.type, address, symbol, decimals, image, chainId)
			};
		}
		...
		async _eth_newFilter(params) {
			...
			return {
				jsonrpc: "2.0",
				id: 0,
				result: await this._filterPolyfill.newFilter(param)
			};
		}
...
//#endregion
//#region node_modules/cbw-sdk/dist/relay/RelayEventManager.js
var require_RelayEventManager = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/cbw-sdk/dist/CoinbaseWalletSDK.js
var require_CoinbaseWalletSDK = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var WalletLinkRelay_1 = require_WalletLinkRelay();
	var version_1 = require_version();
	var CoinbaseWalletSDK = class CoinbaseWalletSDK {
		/**
		* Constructor
		...
		*/
		constructor(options) {
			...
			if (typeof options.overrideIsMetaMask === "undefined") this._overrideIsMetaMask = false;
			else this._overrideIsMetaMask = options.overrideIsMetaMask;
			...
			if (this.walletExtension || this.coinbaseBrowser) return;
		...
		*/
		makeWeb3Provider(jsonRpcUrl = "", chainId = 1) {
			...
			if (extension) {
				if (!this.isCipherProvider(extension)) extension.setProviderInfo(jsonRpcUrl, chainId);
			...
			if (dappBrowser) return dappBrowser;
		...
		*/
		setAppInfo(appName, appLogoUrl) {
			...
			const extension = this.walletExtension;
			if (extension) {
				if (!this.isCipherProvider(extension)) extension.setAppInfo(this._appName, this._appLogoUrl);
		...
		*/
		...
		get coinbaseBrowser() {
			...
			try {
				...
				if (!ethereum) return;
				if ("isCoinbaseBrowser" in ethereum && ethereum.isCoinbaseBrowser) return ethereum;
				return;
			} catch (e) {
				return;
			}
...
//#endregion
//#region node_modules/cbw-sdk/dist/index.js
...
//# sourceMappingURL=dist-DbhOPEj3.js.map